...
**Base path**: `/tmp/claude-0/-home-user-Omni/430dd406-b60a-5efd-abc5-e4512aeb64ac/scratchpad/`
...
- **Note**: `values/strings.xml` nahin hai — strings binary resources.arsc mein hain (partially decoded)
