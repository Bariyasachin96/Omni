    ...
    public static ProviderInfo f(PackageManager object, e object2, Resources object3) {
        ...
        if (providerInfo != null) {
            if (providerInfo.packageName.equals(((e)object2).f())) {
                ...
                object3 = d.d((e)object2, (Resources)object3);
                for (int i3 = 0; i3 < object3.size(); ++i3) {
                    object2 = new ArrayList((Collection)object3.get(i3));
                    Collections.sort(object2, a);
                    if (!d.c((List)object, (List)object2)) continue;
                    return providerInfo;
                }
                return null;
            }
