...
extends o0 {
    ...
    public long c(ViewGroup viewGroup, Transition transition, y object, y y3) {
        ...
        int n7 = viewGroup.getHeight() + var14_10;
        if (rect != null) {
            object3 = rect.centerX();
            object2 = rect.centerY();
        } else {
            object3 = (var11_9 + n6) / 2;
            object2 = (var14_10 + n7) / 2;
        }
        float f3 = (float)this.h((View)viewGroup, n4, n5, (int)object3, (int)object2, (int)var11_9, (int)var14_10, n6, n7) / (float)this.i(viewGroup);
