...
implements b {
        ...
        block12: {
            block15: {
                block14: {
                    ...
                    if (!this.S()) {
                        this.R(fragment, (FrameLayout)object2);
                        object2 = this.j.c(fragment);
                        try {
                            fragment.w1(false);
                            object = this.e.o();
                            StringBuilder stringBuilder = new StringBuilder();
                            stringBuilder.append("f");
                            stringBuilder.append(a4.k());
                            ((y)object).d(fragment, stringBuilder.toString()).p(fragment, f.b.f).h();
                            this.i.d(false);
                            return;
                        }
                        finally {
                            this.j.b((List)object2);
                        }
                    }
    ...
    public final void P(long l3) {
        ...
        if (fragment.X() && this.A(l3)) {
            object = this.j.e(fragment);
            Fragment.SavedState savedState = this.e.h1(fragment);
            this.j.b((List)object);
            this.g.h(l3, savedState);
        }
    ...
    public static class d {
        ...
        public List a(Fragment object, f.b object2) {
