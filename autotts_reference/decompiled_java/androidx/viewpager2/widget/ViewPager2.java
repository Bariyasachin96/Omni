...
extends ViewGroup {
    ...
    public void onMeasure(int n3, int n4) {
        ...
        n9 = Math.max(n5 + (n8 + n9), this.getSuggestedMinimumWidth());
        n10 = Math.max(n6 + (n10 + n11), this.getSuggestedMinimumHeight());
        this.setMeasuredDimension(View.resolveSizeAndState((int)n9, (int)n3, (int)n7), View.resolveSizeAndState((int)n10, (int)n4, (int)(n7 << 16)));
    }
