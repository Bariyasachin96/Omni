...
public abstract class c {
    ...
    public static void j(Context context, Executor executor, c c3, boolean bl) {
        ...
        boolean bl2 = false;
        try {
            packageInfo = object2.getPackageInfo(string, 0);
        }
        ...
        if (!bl && c.d(packageInfo, (File)object2, c3)) {
        ...
        context.getPackageName();
        boolean bl3 = bl2;
        if (c.g((AssetManager)context2, string, packageInfo, (File)object2, (String)object, executor, c3)) {
            bl3 = bl2;
            if (bl) {
                bl3 = true;
            }
