...
extends CompoundButton {
    ...
    public final boolean h(float f3, float f4) {
        ...
        int n8 = rect.right;
        int n9 = this.I;
        return f3 > (float)n6 && f3 < (float)(n3 + n6 + n7 + n8 + n5) && f4 > (float)(n4 - n5) && f4 < (float)(n9 + n5);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (object != null) {
            if (this.p && drawable != null) {
                rect = androidx.appcompat.widget.z.d(drawable);
        ...
        if ((rect2 = this.getTargetCheckedState() ? this.M : this.N) != null) {
            ...
            if (drawable != null) {
                ...
                n3 = drawable.left + drawable.right;
            } else {
                n3 = this.getWidth();
            }
            int n9 = n3 / 2;
            n3 = rect2.getWidth() / 2;
            n4 = (n4 + n6 + (n5 - n7)) / 2;
            n5 = rect2.getHeight() / 2;
            canvas.translate((float)(n9 - n3), (float)(n4 - n5));
            rect2.draw(canvas);
        }
    ...
    public void setSwitchTextAppearance(Context object, int n3) {
        float f3;
        ColorStateList colorStateList = ((m0)(object = m0.t((Context)object, n3, c.j.TextAppearance))).c(c.j.TextAppearance_android_textColor);
        this.L = colorStateList != null ? colorStateList : this.getTextColors();
        n3 = ((m0)object).f(c.j.TextAppearance_android_textSize, 0);
        if (n3 != 0 && (f3 = (float)n3) != this.K.getTextSize()) {
            this.K.setTextSize(f3);
            this.requestLayout();
        }
        this.m(((m0)object).k(c.j.TextAppearance_android_typeface, -1), ((m0)object).k(c.j.TextAppearance_android_textStyle, -1));
        this.O = ((m0)object).a(c.j.TextAppearance_textAllCaps, false) ? new g.a(this.getContext()) : null;
        this.setTextOnInternal(this.q);
        this.setTextOffInternal(this.s);
        ((m0)object).x();
    }
