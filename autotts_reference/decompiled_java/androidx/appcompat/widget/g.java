...
lbl31:
                        ...
                        public boolean e(Context context, int n3, Drawable drawable) {
                            if (n3 == e.abc_seekbar_track_material) {
                                ...
                                Drawable drawable2 = drawable.findDrawableByLayerId(0x1020000);
                                n3 = c.a.colorControlNormal;
                                this.m(drawable2, i0.c(context, n3), b);
                                this.m(drawable.findDrawableByLayerId(16908303), i0.c(context, n3), b);
                                this.m(drawable.findDrawableByLayerId(16908301), i0.c(context, c.a.colorControlActivated), b);
                                return true;
                            }
