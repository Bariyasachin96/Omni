    ...
    public final void a(f object, int n3, int n4, f f3, ArrayList arrayList, m object22) {
        ...
        if (p3.c == null) {
            ...
            if (p3 != ((u.e)object).e && p3 != ((u.e)object).f) {
                ...
                for (Object object3 : p3.i.l) {
                    if (object3 == f3) {
                        ((m)object).b = true;
                    }
                    this.a((f)object3, n3, 1, f3, arrayList, (m)object);
                }
                if (n3 == 1 && p3 instanceof n) {
                ...
                block35: {
                    block36: {
                                            ...
                                            block41: {
                                                block40: {
                                                    block38: {
                                                        ...
                                                        if (n5 != 3) break block38;
                                                        if (var9_18 == b5) {
                                                            this.l(e3, b5, 0, b5, 0);
                                                        }
                                                        n7 = e3.z();
                                                        n5 = (int)((float)n7 * e3.f0 + 0.5f);
                                                        e.b b17 = e.b.c;
                                                        this.l(e3, b17, n5, b17, n7);
                                                        e3.e.e.d(e3.Y());
                                                        e3.f.e.d(e3.z());
                                                        e3.a = true;
                                                        break block39;
                        ...
                        if (n5 != 1 && n7 != 1) {
                            ...
                            e.b[] bArray;
                            e.b b24;
                            if (n7 == 2 && n5 == 2 && (b24 = (bArray = f3.b0)[n4]) == (b23 = e.b.c) && bArray[1] == b23) {
                                f4 = e3.B;
                                f5 = e3.E;
                                this.l(e3, b23, (int)(f4 * (float)f3.Y() + 0.5f), b23, (int)(f5 * (float)f3.z() + 0.5f));
                                e3.e.e.d(e3.Y());
                                e3.f.e.d(e3.z());
                                e3.a = true;
                            }
...
lbl45:
    ...
    public final void i(p object, int n3, ArrayList arrayList) {
        ...
        if (n3 == 1) {
            for (Object object2 : ((n)object).k.k) {
                if (!(object2 instanceof f)) continue;
                this.a((f)object2, n3, 2, null, arrayList, null);
            }
        }
    }
