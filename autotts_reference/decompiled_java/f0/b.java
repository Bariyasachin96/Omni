...
public abstract class b {
    ...
    static {
        float[] fArray = new float[]{0.2126f, 0.7152f, 0.0722f};
        float[] fArray2 = new float[]{0.01932141f, 0.11916382f, 0.9503448f};
        d = new float[][]{{0.41233894f, 0.35762063f, 0.18051042f}, fArray, fArray2};
    }
