...
public class a {
    ...
    public static void d(int n3, l l3, float[] fArray, float[] fArray2) {
        ...
        object2 = l3.i()[0] * (f4 * f3 + f6 * f5 + object2 * f7);
        f9 = l3.i()[1] * (f8 * f3 + f9 * f5 + f10 * f7);
        object5 = l3.i()[2] * (f3 * object3 + f5 * object4 + f7 * object5);
        f3 = (float)Math.pow((double)(l3.c() * Math.abs(object2)) / 100.0, 0.42);
        f5 = (float)Math.pow((double)(l3.c() * Math.abs(f9)) / 100.0, 0.42);
        f7 = (float)Math.pow((double)(l3.c() * Math.abs((float)object5)) / 100.0, 0.42);
        object2 = Math.signum(object2) * 400.0f * f3 / (f3 + 27.13f);
        f5 = Math.signum(f9) * 400.0f * f5 / (f5 + 27.13f);
        object5 = Math.signum((float)object5) * 400.0f * f7 / (f7 + 27.13f);
        double d3 = object2;
        double d4 = f5;
        double d5 = (double)object5;
        f10 = (float)(d3 * 11.0 + d4 * -12.0 + d5) / 11.0f;
        f9 = (float)((double)(object2 + f5) - d5 * 2.0) / 9.0f;
        f7 = f5 * 20.0f;
        f6 = (object2 * 20.0f + f7 + 21.0f * object5) / 20.0f;
        f7 = (object2 * 40.0f + f7 + object5) / 20.0f;
        object5 = (float)Math.atan2(f9, f10) * 180.0f / (float)Math.PI;
        if (object5 < 0.0f) {
        ...
        f8 = (float)Math.PI * object2 / 180.0f;
        f5 = (float)Math.pow(f7 * l3.f() / l3.a(), l3.b() * l3.j()) * 100.0f;
        object4 = 4.0f / l3.b();
        object3 = (float)Math.sqrt(f5 / 100.0f);
        f7 = l3.a();
        f3 = l3.d();
        object5 = (double)object2 < 20.14 ? (Object)(360.0f + object2) : (Object)object2;
        object5 = (float)(Math.cos((double)object5 * Math.PI / 180.0 + 2.0) + 3.8) * 0.25f * 3846.1538f * l3.g() * l3.h() * (float)Math.sqrt(f10 * f10 + f9 * f9) / (f6 + 0.305f);
        f10 = (float)Math.pow(1.64 - Math.pow(0.29, l3.e()), 0.73) * (float)Math.pow((double)object5, 0.9);
        object5 = (float)Math.sqrt((double)f5 / 100.0) * f10;
        f9 = l3.d() * object5;
        f4 = (float)Math.sqrt(f10 * l3.b() / (l3.a() + 4.0f));
        f10 = 1.7f * f5 / (0.007f * f5 + 1.0f);
        f6 = (float)Math.log(0.0228f * f9 + 1.0f) * 43.85965f;
        d5 = f8;
        float f11 = (float)Math.cos(d5);
        f8 = (float)Math.sin(d5);
        fArray2[0] = object2;
        fArray2[1] = (float)object5;
        if (fArray != null) {
            fArray[0] = f5;
            fArray[1] = (float)(object4 * object3 * (f7 + 4.0f) * f3);
            fArray[2] = f9;
            fArray[3] = f4 * 50.0f;
            fArray[4] = f10;
            fArray[5] = f11 * f6;
    ...
    public int o(l object) {
        ...
        object2 = (0.305f + f3) * 23.0f * object2 / (object3 * 0.25f * 3846.1538f * object4 * object5 * 23.0f + 11.0f * object2 * f5 + object2 * 108.0f * f4);
        object4 = f5 * object2;
        f4 = object2 * f4;
        object3 = f3 * 460.0f;
        f3 = (451.0f * object4 + object3 + 288.0f * f4) / 1403.0f;
        object2 = (object3 - 891.0f * object4 - 261.0f * f4) / 1403.0f;
        object5 = (object3 - object4 * 220.0f - f4 * 6300.0f) / 1403.0f;
        ...
        f5 = (float)Math.max(0.0, (double)Math.abs(object2) * 27.13 / (400.0 - (double)Math.abs(object2)));
        object2 = Math.signum(object2);
        object3 = 100.0f / ((l)object).c();
        Object object6 = (float)Math.pow(f5, 2.380952380952381);
        Object object7 = (float)Math.max(0.0, (double)Math.abs(object5) * 27.13 / (400.0 - (double)Math.abs(object5)));
        object5 = Math.signum(object5);
        f5 = 100.0f / ((l)object).c();
        object7 = (float)Math.pow(object7, 2.380952380952381);
        f3 = f3 * f4 * object4 / ((l)object).i()[0];
        f4 = object2 * object3 * object6 / ((l)object).i()[1];
        f5 = object5 * f5 * object7 / ((l)object).i()[2];
        object = f0.b.b;
        Object object8 = object[0];
        Object object9 = object8[0];
        Object object10 = object8[1];
        object6 = object8[2];
        object8 = object[1];
        Object object11 = object8[0];
        object2 = object8[1];
        object4 = object8[2];
        object = object[2];
        object5 = object[0];
        object3 = object[1];
        object7 = object[2];
        return g0.a.b((double)(object9 * f3 + object10 * f4 + object6 * f5), (double)(object11 * f3 + object2 * f4 + object4 * f5), f3 * object5 + f4 * object3 + f5 * object7);
    }
