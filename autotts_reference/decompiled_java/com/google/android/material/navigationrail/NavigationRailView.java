...
extends NavigationBarView {
    ...
    public NavigationRailView(Context context, AttributeSet object, int n3, int n4) {
        ...
        n4 = z1.m.NavigationRailView_contentMarginTop;
        Resources resources = this.getResources();
        n3 = z1.e.mtrl_navigation_rail_margin;
        this.g = ((m0)object).f(n4, resources.getDimensionPixelSize(n3));
        this.h = ((m0)object).f(z1.m.NavigationRailView_headerMarginBottom, this.getResources().getDimensionPixelSize(n3));
        ...
        n3 = this.getResources().getDimensionPixelOffset(z1.e.m3_navigation_rail_item_padding_top_with_large_font);
        n4 = this.getResources().getDimensionPixelOffset(z1.e.m3_navigation_rail_item_padding_bottom_with_large_font);
        float f3 = a.b(0.0f, 1.0f, 0.3f, 1.0f, s2.c.f(context) - 1.0f);
        float f4 = a.c(this.getItemPaddingTop(), n3, f3);
        f3 = a.c(this.getItemPaddingBottom(), n4, f3);
    ...
    public final void t() {
        ...
        Transition transition4 = new b();
        Transition transition5 = new Fade().f0(100L);
        int n3 = this.getNavigationRailMenuView().getChildCount();
        for (int i3 = 0; i3 < n3; ++i3) {
            ...
            if (transitionSet instanceof NavigationBarItemView) {
                ...
                transition4.b((View)navigationBarItemView.getExpandedLabelGroup());
            }
            transition5.b((View)transitionSet);
        }
        transitionSet = new TransitionSet();
        transitionSet.y0(0);
        transitionSet.q0(transition).q0(transition2).q0(transition4);
        if (!this.q) {
            transitionSet.q0(transition5);
        }
        transition4 = new TransitionSet();
        ((TransitionSet)transition4).y0(0);
        ((TransitionSet)transition4).q0(transition3);
        if (this.q) {
            ((TransitionSet)transition4).q0(transition5);
        }
        transition5 = new TransitionSet();
        ((TransitionSet)transition5).y0(1);
        ((TransitionSet)transition5).q0(transition4).q0(transitionSet);
        androidx.transition.c.a((ViewGroup)this.getParent(), transition5);
    }
}
