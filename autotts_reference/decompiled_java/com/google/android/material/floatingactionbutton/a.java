...
public class a {
    ...
    public void y(g object, boolean bl) {
        if (!this.B()) {
            ...
            if (this.Z()) {
                object2 = this.o;
                object2 = object2 != null ? this.i((a2.h)object2, 0.0f, 0.0f, 0.0f) : this.k(0.0f, 0.4f, 0.4f, F, G);
            ...
            object2 = this.v;
            int n4 = bl ? 8 : 4;
            ((VisibilityAwareImageButton)((Object)object2)).b(n4, bl);
            if (object != null) {
                object.b();
            }
        }
