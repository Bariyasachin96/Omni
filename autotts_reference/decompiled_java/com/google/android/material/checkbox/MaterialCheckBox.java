...
extends AppCompatCheckBox {
    ...
    public final void h() {
        ...
        if ((colorStateList = this.o) != null && (drawable = this.r) != null) {
            colorStateList.setTintList((ColorStateList)drawable);
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.k && TextUtils.isEmpty((CharSequence)this.getText()) && (drawable = androidx.core.widget.c.a((CompoundButton)this)) != null) {
            ...
            n3 = (this.getWidth() - drawable.getIntrinsicWidth()) / 2 * n3;
            int n4 = canvas.save();
            ...
            if (this.getBackground() != null) {
                ...
                this.getBackground().setHotspotBounds(canvas.left + n3, canvas.top, canvas.right + n3, canvas.bottom);
            }
            return;
        }
        super.onDraw(canvas);
