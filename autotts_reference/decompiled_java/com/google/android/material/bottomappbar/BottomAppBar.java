                ...
                if (bottomAppBar != null && (view instanceof FloatingActionButton || view instanceof ExtendedFloatingActionButton)) {
                    ...
                    if (this.a.t == 0) {
                        if (bottomAppBar.e0 == 1) {
                            n4 = (view.getMeasuredHeight() - n3) / 2;
                            n3 = bottomAppBar.getResources().getDimensionPixelOffset(z1.e.mtrl_bottomappbar_fab_bottom_margin);
                            ((ViewGroup.MarginLayoutParams)object).bottomMargin = bottomAppBar.getBottomInset() + (n3 - n4);
                        }
