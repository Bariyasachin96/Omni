...
public class o {
     ...
     */
    public static o f(Context object) {
        synchronized (o.class) {
            try {
                o o3;
                if (e != null) return e;
                e = o3 = new o(object.getApplicationContext());
                return e;
            }
    ...
    public void c(String string, String string2) {
        this.h(c3.o$a.d, string, string2);
    }

    public void d(String string, String string2) {
        this.h(c3.o$a.g, string, string2);
    }
    ...
    public final void i() {
        if (this.a.exists() && this.a.length() >= 0x200000L) {
            ...
            for (int i3 = 2; i3 >= 1; --i3) {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                stringBuilder.append("auto_tts.log.");
                stringBuilder.append(i3 + 1);
                object = new File((String)object, stringBuilder.toString());
    ...
    extends Enum {
        ...
        public static final a[] h = c3.o$a.a();
