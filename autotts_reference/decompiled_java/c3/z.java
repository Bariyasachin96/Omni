...
public class z {
    ...
    public static ArrayList g(CharSequence localeSpanArray) {
        ArrayList<z> arrayList = new ArrayList<z>();
        if (AutoTtsService.Q) {
            ...
            for (int i3 = 0; i3 < n4; ++i3) {
                ...
                if (n5 > n3) {
                    arrayList.add(new z(spannableString.subSequence(n3, n5).toString(), "UNKNOWN"));
                }
                arrayList.add(new z(spannableString.subSequence(n5, n6).toString(), localeSpan.getLocale().getLanguage()));
                n3 = n6 + 1;
            }
            if (n3 < spannableString.length()) {
                arrayList.add(new z(spannableString.subSequence(n3, spannableString.length()).toString(), "UNKNOWN"));
            }
            return arrayList;
        }
        arrayList.add(new z(localeSpanArray.toString(), "UNKNOWN"));
        return arrayList;
    }
