...
public class f0 {
    ...
    public static /* synthetic */ void b(f0 f02) {
        f02.getClass();
        try {
            f02.b.stop();
            return;
    ...
    public final void d() {
        this.i = new ThreadPoolExecutor(0, 5, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new c0());
    }
    ...
    public void l() {
        this.i.execute(new e0(this));
    }

    public void m() {
        this.i.execute(new d0(this));
    }
}
