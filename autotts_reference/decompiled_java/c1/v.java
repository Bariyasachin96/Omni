        ...
        if (fArray.length >= 6) {
            ...
            if (n3 % 2 != 1) {
                ...
                while (object.hasNext()) {
                    ...
                    serializable = f7 > (f8 = y.d(f8 - fArray[n3 *= 2], f9 - fArray[n3 + 1])) ? h.a(Float.valueOf(f8 / f7), Float.valueOf(0.0f)) : (f6 > f8 ? h.a(f5, Float.valueOf((f8 - f7) / (f6 - f7))) : h.a(f5, f5));
                ...
                for (n3 = 0; n3 < n7; ++n3) {
                    ...
                    for (n6 = 0; n6 < 2; ++n6) {
                        ...
                        f6 = ((Number)((d3.d)serializable).a()).floatValue();
                        f7 = ((Number)((d3.d)serializable).b()).floatValue();
                ...
                while (n3 < n7) {
                    ...
                    boolean bl = p.a(p.j(l3, l4), p.j(l5, l3));
                    serializable.add(new g.a((List)arrayList2.get(n3), l3, ((t)arrayList3.get(n3)).c(), bl, null));
