...
public class d {
                            ...
                            block22: {
                                ...
                                block20: {
                                    block21: {
                                        ...
                                        f5 = this.b();
                                        f10 = 4;
                                        f14 = f5 * f11 - this.f() * f10 + this.h() * f11;
                                        f5 = -this.b() + this.f();
                                        if (!this.o(f9)) break block20;
                                        if (f14 != 0.0f) break block21;
                                        f4 = f6;
                                        f3 = f7;
                                        break block22;
                                    }
                                    f9 = f5 * f11 / ((float)-2 * f14);
                                    f4 = f6;
                                    f3 = f7;
    ...
    public static final class a {
        ...
        public final d a(float f3, float f4, float f5, float f6, float f7, float f8) {
            ...
            f9 = y.d(f9, f10) * 4.0f / 3.0f;
            f4 = 2;
            f10 = 1.0f;
            float f11 = f10 - f3;
            f4 = f9 * ((float)Math.sqrt(f4 * f11) - (float)Math.sqrt(f10 - f3 * f3)) / f11;
            f3 = bl ? 1.0f : -1.0f;
            f3 = f4 * f3;
