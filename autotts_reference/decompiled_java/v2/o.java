...
public class o {
    ...
    public static b d(Context context, int n3, int n4, d object) {
        ...
        try {
            ...
            int n6 = context.getInt(z1.m.ShapeAppearance_cornerFamilyTopLeft, n5);
            n3 = context.getInt(z1.m.ShapeAppearance_cornerFamilyTopRight, n5);
            n4 = context.getInt(z1.m.ShapeAppearance_cornerFamilyBottomRight, n5);
            ...
            object2 = new b();
            object = ((b)object2).C(n6, d3).G(n3, d4).x(n4, (d)object).t(n5, d5);
            return object;
        }
        finally {
            context.recycle();
