...
public abstract class f1 {
    ...
    public static boolean b(ViewParent viewParent, View object, float f3, float f4) {
        try {
            boolean bl = a.b(viewParent, (View)object, f3, f4);
            return bl;
        }
        catch (AbstractMethodError abstractMethodError) {
            object = new StringBuilder();
    ...
    public static boolean f(ViewParent viewParent, View view, View object, int n3, int n4) {
        if (viewParent instanceof c0) {
            return ((c0)viewParent).m(view, (View)object, n3, n4);
        }
        if (n4 == 0) {
            try {
                boolean bl = a.f(viewParent, view, (View)object, n3);
                return bl;
            }
            catch (AbstractMethodError abstractMethodError) {
                object = new StringBuilder();
