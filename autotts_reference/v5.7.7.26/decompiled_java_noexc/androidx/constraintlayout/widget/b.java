...
public class b {
    ...
    public static void G(Object object, String string, int n3) {
        if (string != null) {
            ...
            if (n4 > 0 && n4 < n5 - 1) {
                ...
                if ((string = string.substring(n4 + 1)).length() > 0) {
                    string2 = string2.trim();
                    string = string.trim();
                    if ("ratio".equalsIgnoreCase(string2)) {
                        if (object instanceof ConstraintLayout.LayoutParams) {
                            object = (ConstraintLayout.LayoutParams)((Object)object);
                            if (n3 == 0) {
                            ...
                            androidx.constraintlayout.widget.b.H((ConstraintLayout.LayoutParams)((Object)object), string);
                            return;
                        }
                        if (object instanceof b) {
                            ((b)object).A = string;
                        ...
                        if (object instanceof a.a) {
                            ((a.a)object).c(5, string);
                            return;
                        }
                    } else if ("weight".equalsIgnoreCase(string2)) {
                        ...
                        float f4 = Math.max(0.0f, Math.min(1.0f, Float.parseFloat(string)));
                        if (object instanceof ConstraintLayout.LayoutParams) {
                            object = (ConstraintLayout.LayoutParams)((Object)object);
                            if (n3 == 0) {
                                ((ViewGroup.MarginLayoutParams)object).width = 0;
    ...
    public static void H(ConstraintLayout.LayoutParams layoutParams, String string) {
        float f3 = Float.NaN;
        int n3 = -1;
        float f4 = f3;
        int n4 = n3;
        if (string != null) {
            ...
            if ((n3 = string.indexOf(58)) >= 0 && n3 < n5 - 1) {
                ...
                if (string2.length() > 0) {
                    ...
                    if (string3.length() > 0) {
                        ...
                        float f6 = Float.parseFloat(string3);
                        f4 = f3;
                        n4 = n8;
                        if (f5 > 0.0f) {
                            f4 = f3;
    ...
    public void C(Context context, int n3) {
        XmlResourceParser xmlResourceParser = context.getResources().getXml(n3);
        int n4 = xmlResourceParser.getEventType();
        while (n4 != 1) {
            if (n4 == 2) {
                String string = xmlResourceParser.getName();
                a a4 = this.t(context, Xml.asAttributeSet((XmlPullParser)xmlResourceParser), false);
     ...
     */
    public void D(Context var1_1, XmlPullParser var2_2) {
        /*
    ...
    public final int[] s(View object, String object2) {
        ...
        while (n3 < stringArray.length) {
            ...
            int n6 = n5 = y.c.class.getField(string).getInt(null);
            if (n5 == 0) {
    ...
    public static class c {
        ...
        public void b(Context context, AttributeSet object) {
            context = context.obtainStyledAttributes((AttributeSet)object, y.d.Motion);
            this.a = true;
            int n3 = context.getIndexCount();
            block12: for (int i3 = 0; i3 < n3; ++i3) {
                ...
                switch (o.get(n4)) {
                    ...
                    case 10: {
                        int n5 = context.peekValue((int)n4).type;
                        if (n5 == 1) {
                            this.n = n5 = context.getResourceId(n4, -1);
                        ...
                        if (n5 == 3) {
                            ...
                            if (((String)object).indexOf("/") > 0) {
                                this.n = context.getResourceId(n4, -1);
                                this.m = -2;
                                continue block12;
                            }
                            this.m = -1;
                        ...
                        this.m = context.getInteger(n4, this.n);
                        continue block12;
                    }
                    case 9: {
                        this.j = context.getFloat(n4, this.j);
                        continue block12;
                    }
                    case 8: {
                        this.k = context.getInteger(n4, this.k);
                        continue block12;
                    }
                    case 7: {
                    ...
                    case 6: {
                        this.c = context.getInteger(n4, this.c);
                        continue block12;
                    }
                    case 5: {
                        this.b = androidx.constraintlayout.widget.b.E((TypedArray)context, n4, this.b);
                    ...
                    case 4: {
                        this.f = context.getInt(n4, 0);
                        continue block12;
                    }
                    case 3: {
                        if (context.peekValue((int)n4).type == 3) {
                            this.d = context.getString(n4);
                            continue block12;
                        }
                        this.d = s.c.c[context.getInteger(n4, 0)];
                        continue block12;
                    }
                    case 2: {
                    ...
                    case 1: {
                        this.i = context.getFloat(n4, this.i);
                    }
                }
            }
            context.recycle();
