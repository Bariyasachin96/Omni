...
public class w {
    ...
    public void c() {
        ...
        Object object = this.c;
        Fragment fragment = ((Fragment)object).j;
        Object object2 = null;
        if (fragment != null) {
            object2 = this.b.n(fragment.h);
            if (object2 == null) {
    ...
    public void e() {
        ...
        if (!fragment.R) {
            ...
            n n3 = this.a;
            fragment = this.c;
            n3.c(fragment, fragment.d, false);
            return;
        }
        fragment.p1(fragment.d);
        this.c.c = 1;
    }
    ...
    public void j() {
        ...
        if (fragment.q && fragment.r && !fragment.t) {
            ...
            fragment = this.c;
            fragment.R0(fragment.V0(fragment.d), null, this.c.d);
            fragment = this.c.K;
            if (fragment != null) {
                fragment.setSaveFromParentEnabled(false);
                fragment = this.c;
                fragment.K.setTag(a1.b.fragment_container_view_tag, (Object)fragment);
                fragment = this.c;
                if (fragment.C) {
                ...
                n n3 = this.a;
                fragment = this.c;
                n3.m(fragment, fragment.K, fragment.d, false);
                this.c.c = 2;
            }
        }
    }
    ...
    public void m() {
        ...
        while (true) {
            ...
            if (n4 > n3) {
                switch (n3 + 1) {
                    ...
                    case 4: {
                        if (fragment.K != null && (object = fragment.J) != null) {
                            e0.n((ViewGroup)object, fragment.E()).b(e0.e.c.b(this.c.K.getVisibility()), this);
                        }
                        this.c.c = 4;
                        break;
                    }
                ...
                switch (n3 - 1) {
                    ...
                    case 3: {
                        ...
                        object = this.c;
                        if (((Fragment)object).p) {
                            this.s();
                        } else if (((Fragment)object).K != null && ((Fragment)object).e == null) {
                            this.t();
                        }
                        object = this.c;
                        if (((Fragment)object).K != null && (fragment = ((Fragment)object).J) != null) {
                            e0.n((ViewGroup)fragment, ((Fragment)object).E()).d(this);
                        }
                        this.c.c = 3;
                        break;
                    }
                    ...
                    case 0: {
                        if (fragment.p && this.b.q(fragment.h) == null) {
                            this.s();
                        }
                        this.g();
                        break;
        ...
        if (!bl && n3 == -1 && fragment.o && !fragment.Z() && !this.c.p) {
            if (FragmentManager.I0(3)) {
                Objects.toString(this.c);
            }
            this.b.p().f(this.c);
        ...
        if (fragment.P) {
            if (fragment.K != null && (object = fragment.J) != null) {
                object = e0.n((ViewGroup)object, fragment.E());
                if (this.c.C) {
                    ((e0)object).c(this);
                } else {
                    ((e0)object).e(this);
            ...
            object = fragment.v;
            if (object != null) {
                ((FragmentManager)object).G0(fragment);
            }
            object = this.c;
            ((Fragment)object).P = false;
            ((Fragment)object).u0(((Fragment)object).C);
            this.c.x.I();
        }
        this.d = false;
    }
