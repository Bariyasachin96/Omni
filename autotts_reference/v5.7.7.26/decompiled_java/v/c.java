...
extends p {
    ...
    public void a(d object) {
                ...
                while (n7 < n9) {
                    ...
                    if (((p)object).b.X() == 8) {
                        ...
                        if (n7 > 0) {
                            n3 = n8;
                            if (n7 >= n6) {
                                n3 = bl ? n8 - ((p)object).h.f : n8 + ((p)object).h.f;
                            }
                        }
                        if (bl) {
                            ((p)object).i.d(n3);
        ...
        while (n7 < n9) {
            ...
            if (((p)object).b.X() == 8) {
                ...
                g g6 = ((p)object).e;
                n8 = g6.g;
                if (((p)object).d == e.b.e && ((p)object).a == 1) {
                    n8 = g6.m;
                }
                n3 = bl ? (n3 -= n8) : (n3 += n8);
                if (bl) {
    ...
    public void d() {
        ...
        if (this.f == 0) {
            ...
            Object object3 = ((e)object2).R;
            object = ((e)object).T;
            object2 = this.i((u.d)object3, 1);
            n3 = ((u.d)object3).f();
            object3 = this.r();
            if (object3 != null) {
                n3 = ((e)object3).R.f();
