...
public class o {
    ...
    public static b d(Context context, int n3, int n4, d object) {
        ...
        try {
            ...
            n3 = context.getInt(z1.m.ShapeAppearance_cornerFamilyTopRight, n5);
            ...
            object = o.m((TypedArray)context, z1.m.ShapeAppearance_cornerSizeTopLeft, (d)object2);
            d d3 = o.m((TypedArray)context, z1.m.ShapeAppearance_cornerSizeTopRight, (d)object2);
            d d4 = o.m((TypedArray)context, z1.m.ShapeAppearance_cornerSizeBottomRight, (d)object2);
            d d5 = o.m((TypedArray)context, z1.m.ShapeAppearance_cornerSizeBottomLeft, (d)object2);
            object2 = new b();
            object = ((b)object2).C(n4, (d)object).G(n3, d3).x(n6, d4).t(n5, d5);
            return object;
        }
        finally {
            context.recycle();
