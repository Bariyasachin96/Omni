...
implements Animatable {
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        Object object = this.c;
        if (object != null) {
            h0.a.g((Drawable)object, resources, xmlPullParser, attributeSet, theme);
            return;
        }
        ...
        while (n3 != 1 && (xmlPullParser.getDepth() >= n4 + 1 || n3 != 3)) {
            if (n3 == 2) {
                ...
                if ("animated-vector".equals(object)) {
                    ...
                    if (n3 != 0) {
                        object = n1.g.b(resources, n3, theme);
                        ((g)((Object)object)).g(false);
                        object.setCallback(this.j);
                        object2 = this.d.b;
                        if (object2 != null) {
                    ...
                    if (n3 != 0) {
                        typedArray = this.e;
                        if (typedArray != null) {
                            this.e((String)object2, n1.e.a((Context)typedArray, n3));
                        } else {
                            object.recycle();
