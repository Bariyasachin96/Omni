...
extends f {
    ...
    public g() {
        ...
        block3: {
            try {
                clazz = this.t();
                executable2 = this.u(clazz);
                method = this.q(clazz);
                executable = this.r(clazz);
            ...
            ((StringBuilder)object3).append(executable2.getClass().getName());
            Log.e((String)"TypefaceCompatApi26Impl", (String)((StringBuilder)object3).toString(), (Throwable)((Object)executable2));
            clazz = null;
            Object var8_10 = null;
            method = null;
            executable2 = method;
            object = object2 = (object3 = executable2);
            executable = executable2;
            executable2 = var8_10;
        }
        this.g = clazz;
