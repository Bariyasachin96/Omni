...
public final class t {
    ...
    public t(long l3, long l4, long l5, c c3) {
        ...
        this.i = f3 = p.d(l3, l4);
        float f6 = 1.0f;
        this.j = f5 = (float)Math.sqrt(f6 - y.n(f3));
        f4 = (double)f5 > 0.001 ? f4 * (f3 + f6) / f5 : 0.0f;
        this.k = f4;
    ...
    public final List d(float f3, float f4) {
        ...
        if (!(f6 < 1.0E-4f || f5 < 1.0E-4f || this.g < 1.0E-4f)) {
            ...
            f3 = this.a(f3);
            f5 = this.a(f4);
            float f7 = this.g * f6 / this.k;
            f4 = (float)Math.sqrt(y.n(f7) + y.n(f6));
            this.l = p.k(this.b, p.l(p.e(p.b(p.k(this.e, this.f), 2.0f)), f4));
            long l4 = p.k(this.b, p.l(this.e, f6));
            long l5 = p.k(this.b, p.l(this.f, f6));
            d d3 = this.b(f6, f3, this.b, this.a, l4, l5, this.l, f7);
            d d4 = this.b(f6, f5, this.b, this.c, l5, l4, this.l, f7).l();
