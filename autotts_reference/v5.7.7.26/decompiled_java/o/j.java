...
implements Cloneable {
    ...
    public j b() {
        ...
        o3.k.c(object, "null cannot be cast to non-null type androidx.collection.LongSparseArray<E of androidx.collection.LongSparseArray>");
        object = (j)object;
    ...
    public void h(long l3, Object object) {
        ...
        if ((n5 = this.f) >= this.d.length) {
            ...
            o3.k.d(objectArray, "copyOf(this, newSize)");
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < n3; ++i3) {
            ...
            ((StringBuilder)charSequence).append(this.g(i3));
            ((StringBuilder)charSequence).append('=');
            Object object = this.l(i3);
        ...
        o3.k.d(charSequence, "StringBuilder(capacity).…builderAction).toString()");
        return charSequence;
    }
}
