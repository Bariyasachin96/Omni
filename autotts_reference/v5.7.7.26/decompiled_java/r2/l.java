    ...
    public void draw(Canvas canvas) {
        if (!this.getBounds().isEmpty() && this.isVisible() && canvas.getClipBounds(this.r)) {
            ...
            if (bl3) {
                ...
                object = this.u.b;
                j.a a4 = (j.a)object.get(object.size() - 1);
                j j3 = this.t;
                if (j3 instanceof m) {
                    object = this.p;
                    float f3 = ((j.a)object2).a;
                    int n6 = this.d.f;
                    j3.d(canvas, (Paint)object, 0.0f, f3, n6, n5, n4);
                    this.t.d(canvas, this.p, a4.b, 1.0f, this.d.f, n5, n4);
                } else {
                    canvas.save();
                    canvas.rotate(a4.g);
                    this.t.d(canvas, this.p, a4.b, ((j.a)object2).a + 1.0f, this.d.f, n5, n4);
                    canvas.restore();
                }
            }
