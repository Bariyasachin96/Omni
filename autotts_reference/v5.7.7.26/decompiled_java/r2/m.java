...
extends j {
    ...
    public void b(Canvas canvas, Paint paint, int n3, int n4) {
        ...
        if (((LinearProgressIndicatorSpec)this.a).r > 0 && n3 != 0) {
            ...
            paint.setColor(n3);
            b b3 = this.a;
            float f3 = ((LinearProgressIndicatorSpec)b3).s != null ? ((LinearProgressIndicatorSpec)b3).s.floatValue() + (float)((LinearProgressIndicatorSpec)this.a).r / 2.0f : this.g / 2.0f;
            j.b b4 = new j.b(this, new float[]{this.f / 2.0f - f3, 0.0f}, new float[]{1.0f, 0.0f});
            b3 = this.a;
            this.l(canvas, paint, b4, ((LinearProgressIndicatorSpec)b3).r, ((LinearProgressIndicatorSpec)b3).r, this.h * (float)((LinearProgressIndicatorSpec)b3).r / this.g);
        }
    }
    ...
    public final void k(Canvas canvas, Paint paint, float f3, float f4, int n3, int n4, int n5, float f5, float f6, boolean bl) {
        ...
        int n6 = (int)((float)n5 * (1.0f - j0.a.a(f9, 0.99f, 1.0f)) / 0.01f);
        f4 = this.f;
        n5 = (int)(f3 * f4 + (float)n4);
        n6 = (int)(f9 * f4 - (float)n6);
        f3 = this.h;
        f4 = this.i;
        if (f3 != f4) {
            f4 = Math.max(f3, f4);
        ...
        if (n5 <= n6) {
            ...
            if (n5 == 0 && f11 + f4 < f7 + f3) {
                ...
                f5 = this.g;
                this.m(canvas, paint, b3, f9, f5, f3, (j.b)pair.second, f8, f5, f4, true);
                return;
            }
            if (f7 - f3 > f11 - f4) {
                Pair pair = this.o;
                ...
                f5 = this.g;
                this.m(canvas, paint, b4, f8, f5, f4, (j.b)pair.first, f9, f5, f3, false);
                return;
            }
            ...
            if (n4 == 0) {
                ...
                Pair pair = this.o;
                f10 = this.f;
                this.j((PathMeasure)object, path, pair, f7 / f10, f11 / f10, f5, f6);
            ...
            if (!((LinearProgressIndicatorSpec)this.a).g()) {
                ...
                if (f11 < this.f && f4 > 0.0f) {
                    this.l(canvas, paint, (j.b)this.o.second, f8, this.g, f4);
                }
            }
        }
    }
