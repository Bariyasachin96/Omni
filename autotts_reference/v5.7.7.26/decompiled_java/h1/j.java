...
public abstract class j {
    ...
    public static l E(b[] object) {
        ...
        block7: {
            ...
            try {
                c.p(byteArrayOutputStream, ((b[])object).length);
                n3 = 2;
                for (int i3 = 0; i3 < ((b[])object).length; ++i3) {
                    object2 = object[i3];
                ...
                if (n3 != ((b[])object).length) break block7;
                object = new l(d.d, n3, (byte[])object, false);
            }
    ...
    public static void K(OutputStream outputStream, b object) {
        ...
        while (object.hasNext()) {
            ...
            int n4 = (Integer)entry.getKey();
            if (((Integer)entry.getValue() & 1) == 0) continue;
    ...
    public static l d(b[] object) {
        ...
        block8: {
            ...
            while (true) {
                ...
                int n5 = j.a((b)object2);
                byArray = j.e(n5, (b)object2);
                object2 = j.f((b)object2);
                c.p(byteArrayOutputStream, n4);
                int n6 = byArray.length + 2 + ((Object)object2).length;
            ...
            try {
                ...
                if (n3 != byArray.length) break block8;
                object = new l(d.g, n3, byArray, true);
            }
            catch (Throwable throwable2) {}
            byteArrayOutputStream.close();
            return object;
    ...
    public static b[] t(InputStream inputStream, int n3, b[] bArray) {
        ...
        if (n3 == bArray.length) {
            ...
            while (true) {
                if (n4 >= n3) break;
                n6 = c.h(inputStream);
                nArray[n4] = c.h(inputStream);
                stringArray[n4] = c.f(inputStream, n6);
                ++n4;
            }
            for (n6 = n5; n6 < n3; ++n6) {
                b b3 = bArray[n6];
                if (b3.b.equals(stringArray[n6])) {
                    b3.e = n4 = nArray[n6];
                    b3.h = j.n(inputStream, n4);
                    continue;
                }
