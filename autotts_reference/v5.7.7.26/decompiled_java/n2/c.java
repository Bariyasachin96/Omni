...
public class c {
    ...
    static {
        ...
        u[] uArray = k.Q(k.t, true, new RectF(-1.0f, -1.0f, 1.0f, 1.0f));
        u u6 = k.Q(k.v, true, new RectF(-1.0f, -1.0f, 1.0f, 1.0f));
        u u7 = k.Q(k.m, true, new RectF(-1.0f, -1.0f, 1.0f, 1.0f));
        u[] uArray2 = new u[]{u3, u4, u5, mArray, uArray, u6, u7};
        d = uArray2;
        ...
        while (n3 < (uArray = d).length) {
            ...
            u4 = uArray[n3];
            int n4 = n3 + 1;
            mArray[n3] = new m(u4, uArray[n4 % uArray.length]);
            n3 = n4;
        }
    }
    ...
    public void c(Canvas canvas, Paint paint, a a4, int n3) {
        ...
        canvas.rotate(a4.c);
        this.b.rewind();
        int n4 = (int)Math.floor(a4.b);
        m[] mArray = e;
        n3 = o2.a.d(n4, mArray.length);
        float f3 = a4.b;
        float f4 = n4;
        x.b(mArray[n3], f3 - f4, this.b);
        a4 = this.c;
        n3 = this.a.b;
