...
implements ServiceConnection {
    ...
    private void checkLicenseInternal(IBinder var1_1) throws LicenseCheckException, RemoteException {
         ...
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Back jump on a try block [egrp 1[TRYBLOCK] [3 : 108->131)] java.lang.Throwable
    ...
    private void processResponse(int var1_1, Bundle var2_2) {
        ...
        if (var1_1 == 0) {
            ...
            var4_6 = new LicenseClient$$ExternalSyntheticLambda10(this, var3_4, var2_2 /* !! */ );
            var5_5.run(var4_6);
            return;
        }
...
lbl19:
    ...
    public void reportSuccessfulLicenseCheck(IBinder var1_1) throws LicenseCheckException {
         ...
         * This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
         * 
         * org.benf.cfr.reader.util.ConfusedCFRException: Back jump on a try block [egrp 3[TRYBLOCK] [9 : 123->162)] java.lang.Throwable
         *     at org.benf.cfr.reader.bytecode.analysis.opgraph.Op02WithProcessedDataAndRefs.insertExceptionBlocks(Op02WithProcessedDataAndRefs.java:2283)
         *     at org.benf.cfr.reader.bytecode.CodeAnalyser.getAnalysisInner(CodeAnalyser.java:415)
         *     at org.benf.cfr.reader.bytecode.CodeAnalyser.getAnalysisOrWrapFail(CodeAnalyser.java:278)
         *     at org.benf.cfr.reader.bytecode.CodeAnalyser.getAnalysis(CodeAnalyser.java:201)
