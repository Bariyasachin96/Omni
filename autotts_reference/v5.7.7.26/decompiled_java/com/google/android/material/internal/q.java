...
implements androidx.appcompat.view.menu.i {
    ...
    public final View.OnClickListener F = new View.OnClickListener(this){
        ...
        public void onClick(View object) {
            ...
            boolean bl = true;
            ((q)object2).Y(true);
            object2 = ((NavigationMenuItemView)object).getItemData();
            object = this.c;
    ...
    extends RecyclerView.h {
        ...
        public void M(Bundle bundle) {
            ...
            int n4;
            int n5 = 0;
            int n6 = bundle.getInt("android:menu:checked", 0);
            if (n6 != 0) {
                this.f = true;
                n4 = this.d.size();
                for (n3 = 0; n3 < n4; ++n3) {
                    object = (e)this.d.get(n3);
                    if (!(object instanceof g) || (object = ((g)object).a()) == null || ((androidx.appcompat.view.menu.g)object).getItemId() != n6) continue;
