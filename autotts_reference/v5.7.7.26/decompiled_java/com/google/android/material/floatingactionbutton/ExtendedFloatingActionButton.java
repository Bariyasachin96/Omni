...
implements CoordinatorLayout.b {
    ...
    public ExtendedFloatingActionButton(Context object, AttributeSet attributeSet, int n3) {
        ...
        a4 = com.google.android.material.internal.z.i(context, attributeSet, z1.m.ExtendedFloatingActionButton, n3, n5, new int[0]);
        h h3 = a2.h.c(context, (TypedArray)a4, z1.m.ExtendedFloatingActionButton_showMotionSpec);
        h h4 = a2.h.c(context, (TypedArray)a4, z1.m.ExtendedFloatingActionButton_hideMotionSpec);
        h h5 = a2.h.c(context, (TypedArray)a4, z1.m.ExtendedFloatingActionButton_extendMotionSpec);
        h h6 = a2.h.c(context, (TypedArray)a4, z1.m.ExtendedFloatingActionButton_shrinkMotionSpec);
        this.T = a4.getDimensionPixelSize(z1.m.ExtendedFloatingActionButton_collapsedSize, -1);
        this.g0 = n4 = a4.getInt(z1.m.ExtendedFloatingActionButton_extendStrategy, 1);
        this.U = this.getPaddingStart();
        this.V = this.getPaddingEnd();
        Object object2 = new a();
        j j3 = new j(this, (a)object2, this.H(n4), true);
        this.Q = j3;
        this.P = object2 = new j(this, (a)object2, new n(this){
