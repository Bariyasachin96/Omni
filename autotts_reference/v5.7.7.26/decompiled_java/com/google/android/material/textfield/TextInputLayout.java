...
implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private Drawable getOrCreateFilledDropDownMenuBackground() {
        if (this.K == null) {
            ...
            this.K = stateListDrawable = new StateListDrawable();
            Drawable drawable = this.getOrCreateOutlinedDropDownMenuBackground();
            stateListDrawable.addState(new int[]{0x10100AA}, drawable);
            stateListDrawable = this.K;
            drawable = this.H(false);
    ...
    public void onRtlPropertiesChanged(int n3) {
        ...
        if (bl != this.P) {
            ...
            Object object = this.O.q();
            v2.e e3 = this.O.s();
            v2.e e4 = this.O.i();
            v2.e e5 = this.O.k();
            object = v2.o.a().D(e3).H((v2.e)object).u(e5).y(e4).E(f4).I(f3).v(f6).z(f5).m();
            this.P = bl;
    ...
    public boolean p0() {
        block12: {
            ...
            if ((var5_4 = (var6_5 = this.g.getCompoundDrawablesRelative())[0]) == (var7_6 = this.f0)) ** GOTO lbl-1000
            this.g.setCompoundDrawablesRelative(var7_6, var6_5[1], var6_5[2], var6_5[3]);
            ** GOTO lbl19
        }
        if (this.f0 != null) {
...
lbl19:
        ...
        if (this.e0()) {
            ...
            var5_4 = this.g.getCompoundDrawablesRelative();
            var6_5 = this.i0;
            if (var6_5 != null && this.j0 != var1_3) {
                this.j0 = var1_3;
                var6_5.setBounds(0, 0, var1_3, 1);
                this.g.setCompoundDrawablesRelative(var5_4[0], var5_4[1], this.i0, var5_4[3]);
                return true;
            }
            if (var6_5 == null) {
                this.i0 = var6_5 = new ColorDrawable();
                this.j0 = var1_3;
                var6_5.setBounds(0, 0, var1_3, 1);
            }
            if ((var7_6 = var5_4[2]) != (var6_5 = this.i0)) {
                this.k0 = var7_6;
                this.g.setCompoundDrawablesRelative(var5_4[0], var5_4[1], var6_5, var5_4[3]);
                return true;
            }
