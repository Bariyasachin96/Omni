            ...
            public void g(Canvas canvas, RecyclerView recyclerView, RecyclerView.z object) {
                if (recyclerView.getAdapter() instanceof w && recyclerView.getLayoutManager() instanceof GridLayoutManager) {
                    ...
                    for (d d3 : this.c.g0.f()) {
                        ...
                        object2 = ((LinearLayoutManager)object).H(n3);
                        View view = ((LinearLayoutManager)object).H(n4);
                        int n5 = n3 / ((GridLayoutManager)object).X2();
                        int n6 = n4 / ((GridLayoutManager)object).X2();
                        for (n4 = n5; n4 <= n6; ++n4) {
                            d3 = ((LinearLayoutManager)object).H(((GridLayoutManager)object).X2() * n4);
                            if (d3 == null) continue;
                            int n7 = d3.getTop();
