...
implements DateSelector<Long> {
    ...
    public View n(LayoutInflater object, ViewGroup object2, Bundle object3, CalendarConstraints calendarConstraints, r r3) {
        ...
        object3 = (TextInputLayout)view.findViewById(g.mtrl_picker_text_input_date);
        EditText editText = ((TextInputLayout)((Object)object3)).getEditText();
        ...
        editText.addTextChangedListener((TextWatcher)new e(this, (String)object2, (DateFormat)object, (TextInputLayout)((Object)object3), calendarConstraints, r3, (TextInputLayout)((Object)object3)){
            public final r k;
