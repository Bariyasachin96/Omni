...
extends NavigationBarMenuView {
    ...
    public void onMeasure(int n3, int n4) {
        ...
        n5 = n6 > 1 && this.j(this.getLabelVisibilityMode(), n6) ? this.u(n3, n5, n6) : this.t(n3, n5, n6, null);
        this.setMeasuredDimension(View.MeasureSpec.getSize((int)n3), View.resolveSizeAndState((int)n5, (int)n4, (int)0));
    }
    ...
    public final int t(int n3, int n4, int n5, View view) {
        ...
        n11 = Math.max(n11, 0);
        n5 = view == null ? this.r(n3, n11, n5) : View.MeasureSpec.makeMeasureSpec((int)view.getMeasuredHeight(), (int)0);
        n10 = 0;
        for (n11 = 0; n11 < n9; ++n11) {
            view2 = this.getChildAt(n11);
            n7 = n10;
    ...
    public final int u(int n3, int n4, int n5) {
        ...
        if (view != null) {
            int n7 = this.s(view, n3, this.r(n3, n4, n5));
            n4 -= n7;
            n6 = n5 - 1;
            n5 = n7;
        } else {
        ...
        return n5 + this.t(n3, n4, n6, view);
    }
}
