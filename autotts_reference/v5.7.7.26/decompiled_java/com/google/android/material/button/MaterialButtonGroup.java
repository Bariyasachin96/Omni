...
extends LinearLayout {
    ...
    public MaterialButtonGroup(Context context, AttributeSet object, int n3) {
        int n4 = m;
        ...
        TypedArray typedArray = z.i(context, object, z1.m.MaterialButtonGroup, n3, n4, new int[0]);
        n3 = z1.m.MaterialButtonGroup_buttonSizeChange;
        if (typedArray.hasValue(n3)) {
            this.k = x.b(context, typedArray, n3);
        }
        if (typedArray.hasValue(n3 = z1.m.MaterialButtonGroup_shapeAppearance)) {
            object = w.b(context, typedArray, n3);
            this.i = object;
            if (object == null) {
                this.i = new w.b(o.b(context, typedArray.getResourceId(n3, 0), typedArray.getResourceId(z1.m.MaterialButtonGroup_shapeAppearanceOverlay, 0)).m()).j();
            }
        }
        if (typedArray.hasValue(n3 = z1.m.MaterialButtonGroup_innerCornerSize)) {
            this.h = v.b(context, typedArray, n3, new v2.a(0.0f));
        }
        this.j = typedArray.getDimensionPixelSize(z1.m.MaterialButtonGroup_android_spacing, 0);
        this.setChildrenDrawingOrderEnabled(true);
        this.setEnabled(typedArray.getBoolean(z1.m.MaterialButtonGroup_android_enabled, true));
        typedArray.recycle();
    }
