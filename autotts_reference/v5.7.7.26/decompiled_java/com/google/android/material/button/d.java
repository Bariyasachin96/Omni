...
public class d {
    ...
    public void t(TypedArray typedArray) {
        ...
        int n4 = this.a.getPaddingStart();
        int n5 = this.a.getPaddingTop();
        int n6 = this.a.getPaddingEnd();
        n3 = this.a.getPaddingBottom();
        if (typedArray.hasValue(z1.m.MaterialButton_android_background)) {
            this.v();
        } else {
            this.M();
        }
        this.a.setPaddingRelative(n4 + this.f, n5 + this.h, n6 + this.g, n3 + this.i);
    }
