...
public class a {
     ...
     */
    public final void a(Context var1_1, int var2_2) {
        block15: {
            block16: {
                ...
                Log.e((String)"ConstraintLayoutStates", (String)var1_1.toString(), (Throwable)var4_6);
                return;
            }
            var1_1 = new StringBuilder();
            var1_1.append("Error parsing resource: ");
        ...
        while (var3_4 != 1) {
            block18: {
                ...
                switch (var7_9.hashCode()) {
                    ...
                    case 1901439077: {
                        var5_8 = var4_5;
                        if (var7_9.equals("Variant")) {
                            var7_9 = new b((Context)var1_1, (XmlPullParser)var6_3);
                            var5_8 = var4_5;
                            if (var4_5 != null) {
                                var4_5.a((b)var7_9);
                                var5_8 = var4_5;
...
lbl53:
                        ...
                        var7_9.equals(var5_8);
                        var5_8 = var4_5;
                        break block18;
                    }
                    case 80204913: {
                        var5_8 = var4_5;
                        if (var7_9.equals("State")) {
                            var5_8 = new a((Context)var1_1, (XmlPullParser)var6_3);
                            this.e.put(var5_8.a, var5_8);
                        }
                        break block18;
                    }
                    case -1349929691: 
                ...
                if (var7_9.equals("ConstraintSet")) {
                    this.b((Context)var1_1, (XmlPullParser)var6_3);
                    var5_8 = var4_5;
                }
            }
            var3_4 = var6_3.next();
