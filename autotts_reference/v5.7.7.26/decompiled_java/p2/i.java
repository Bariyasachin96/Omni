...
extends a {
    ...
    public final float[] h() {
        ...
        if (Build.VERSION.SDK_INT >= 31 && (windowInsets = this.b.getRootWindowInsets()) != null) {
            ...
            DisplayMetrics displayMetrics = object[1];
            int n5 = this.b.getWidth();
            int n6 = this.b.getHeight();
            int n7 = object2 == false && displayMetrics == false ? this.q(windowInsets, 0) : 0;
            int n8 = n5 + object2;
            n5 = n8 >= n3 && displayMetrics == false ? this.q(windowInsets, 1) : 0;
            n3 = n8 >= n3 && displayMetrics + n6 >= n4 ? this.q(windowInsets, 2) : 0;
            object2 = object2 == false && displayMetrics + n6 >= n4 ? (Object)this.q(windowInsets, 3) : (Object)false;
            float f3 = n7;
            float f4 = n5;
            float f5 = n3;
