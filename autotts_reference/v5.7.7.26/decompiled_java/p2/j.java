...
extends a {
    ...
    public void h(androidx.activity.b b3, int n3, Animator.AnimatorListener animatorListener, ValueAnimator.AnimatorUpdateListener animatorUpdateListener) {
        ...
        property = ObjectAnimator.ofFloat((Object)view, (Property)property, (float[])new float[]{f4});
        if (animatorUpdateListener != null) {
            property.addUpdateListener(animatorUpdateListener);
        }
        property.setInterpolator((TimeInterpolator)new b());
        property.setDuration((long)a2.a.c(this.c, this.d, b3.a()));
        property.addListener((Animator.AnimatorListener)new AnimatorListenerAdapter(this, bl, n3){
        ...
        if (animatorListener != null) {
            property.addListener(animatorListener);
        }
        property.start();
    }
    ...
    public void k(float f3, boolean bl, int n3) {
        ...
        view = (ViewGroup)view;
        while (n4 < view.getChildCount()) {
            View view2 = view.getChildAt(n4);
            n6 = bl2 ? n5 - view2.getRight() + view2.getWidth() : -view2.getLeft();
            f3 = n6;
            view2.setPivotX(f3);
