...
d {
    ...
    public static Fragment W(Context object, String string, Bundle object2) {
        ...
        block10: {
            ...
            block9: {
                ...
                throw new k(((StringBuilder)object).toString(), noSuchMethodException2);
            }
        ...
        ((StringBuilder)object2).append(string);
        ((StringBuilder)object2).append(": make sure class name exists, is public, and has an empty constructor that is public");
        throw new k(((StringBuilder)object2).toString(), instantiationException2);
    }
    ...
    public void a(boolean bl) {
        ...
        if (this.K != null && (object = this.J) != null && (fragmentManager = this.v) != null) {
            object = e0.n((ViewGroup)object, fragmentManager);
            ((e0)object).p();
            if (bl) {
