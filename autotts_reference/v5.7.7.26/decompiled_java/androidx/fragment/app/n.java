...
public class n {
    ...
    public void g(Fragment fragment, boolean bl) {
        ...
        Object object2 = this.b.y0();
        if (object2 != null) {
            ((Fragment)object2).E().x0().g(fragment, true);
        }
        for (Object object2 : this.a) {
            if (bl && !((a)object2).b) continue;
            ((a)object2).a.g(this.b, fragment, context);
        }
    }
    ...
    public void k(Fragment fragment, boolean bl) {
        Object object2 = this.b.y0();
        if (object2 != null) {
            ((Fragment)object2).E().x0().k(fragment, true);
        }
        for (Object object2 : this.a) {
            if (bl && !((a)object2).b) continue;
            ((a)object2).a.k(this.b, fragment);
        }
    }
    ...
    public void n(Fragment fragment, boolean bl) {
        Fragment fragment2 = this.b.y0();
        if (fragment2 != null) {
            fragment2.E().x0().n(fragment, true);
        }
        for (a a4 : this.a) {
            if (bl && !a4.b) continue;
            a4.a.n(this.b, fragment);
        }
    }
