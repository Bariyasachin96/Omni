...
public class b {
    ...
    static {
        ...
        float[] fArray2 = new float[]{0.0f, 0.5f};
        float[] fArray3 = new float[]{0.5f, 0.5f};
        float[] fArray4 = new float[]{1.0f, 0.5f};
        G = new float[][]{fArray, fArray2, {1.0f, 0.5f}, {0.5f, 1.0f}, fArray3, {0.0f, 0.5f}, fArray4};
                            ...
                            if (n3 == 2) {
                                ...
                                if (Math.abs(this.m * f7 + this.n * f6) > this.z || this.o) {
                                    ...
                                    if (f9 != (f7 = this.t.getProgress())) {
                                        ...
                                        f7 = f3.c();
                                        f9 = f3.b();
                                        f7 = this.m != 0.0f ? (f7 /= this.p[0]) : f9 / this.p[1];
                                        this.t.E = f7;
                                    } else {
                                        this.t.E = 0.0f;
                                    }
                ...
                block31: {
                    ...
                    if (n4 != 1) {
                        ...
                        if (n4 != -1) {
                            ...
                            f9 = this.q[0];
                            f10 = (float)(object5.getLeft() + object5.getRight()) / 2.0f;
                            f8 = this.q[1];
                        ...
                        f11 = Math.max(Math.min(f11 + f10 * this.x / this.p[1], 1.0f), 0.0f);
