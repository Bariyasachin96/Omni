...
implements d0 {
    ...
    public void H0(int n3, int n4, int n5, int n6) {
        ...
        if ((f3 = this.B.E()) != 0.0f) {
            ...
            for (n3 = n5; n3 < n6; ++n3) {
                ...
                ((m)object).n = f3 - (f7 + f4 - f5) * f3 / (f6 - f5);
            }
        }
        this.O = 0.0f;
        this.P = 0.0f;
                ...
                block61: {
                    block51: {
                        block60: {
                                                ...
                                                block55: {
                                                    block52: {
                                                        block53: {
                                                            ...
                                                            l3 = this.getNanoTime();
                                                            object = this.C;
                                                            f5 = !(object instanceof n) ? (float)(l3 - this.Q) * f6 * 1.0E-9f / this.N : 0.0f;
                                                            f3 = this.P + f5;
                                                            if (this.S) {
                                                                f3 = this.R;
                                                            }
                                                            ...
                                                            this.O = f3;
                                                            this.Q = l3;
                                                            if (object == null || n4 != 0) break block52;
                                                            if (!this.d0) break block53;
                                                            f4 = object.getInterpolation((float)(l3 - this.M) * 1.0E-9f);
                                                            interpolator = this.C;
                                                            object = this.e0;
                                                            ...
                                                            object = this.C;
                                                            f3 = f4;
                                                            if (!(object instanceof n)) break block54;
                                                            this.E = f7 = ((n)object).a();
                                                        ...
                                                        f4 = object.getInterpolation(f3);
                                                        object = this.C;
                                                        this.E = object instanceof n ? ((n)object).a() : (object.getInterpolation(f3 + f5) - f4) * f6 / f5;
                                                        f3 = f4;
                                                        break block55;
                                                    }
                                                    this.E = f5;
                            ...
                            this.J0 = f5;
                            object = this.D;
                            f3 = object == null ? f5 : object.getInterpolation(f5);
                            object = this.D;
                            if (object != null) {
                                this.E = f4 = object.getInterpolation(f6 / this.N + f5);
    ...
    public final void i0() {
        ...
        block12: {
            block11: {
                ...
                l3 = this.getNanoTime();
                interpolator = this.C;
                float f7 = !(interpolator instanceof w.b) ? (float)(l3 - this.Q) * f6 * 1.0E-9f / this.N : 0.0f;
                f4 = this.P + f7;
                if (this.S) {
                    f4 = this.R;
                }
                ...
                if (interpolator != null) {
                    f7 = f4;
                    if (n3 == 0) {
                        f7 = this.d0 ? interpolator.getInterpolation((float)(l3 - this.M) * 1.0E-9f) : interpolator.getInterpolation(f4);
                    }
                }
        ...
        for (n3 = n4; n3 < f3; ++n3) {
            interpolator = this.getChildAt(n3);
            m m3 = (m)this.L.get(interpolator);
            if (m3 == null) continue;
            m3.x((View)interpolator, f4, l3, this.K0);
        }
        if (this.C0) {
            this.requestLayout();
        }
    ...
    public void onAttachedToWindow() {
        ...
        if ((object = this.B) != null && (n3 = this.G) != -1) {
            ...
            if (object != null) {
                ((androidx.constraintlayout.widget.b)object).i(this);
            }
            this.F = this.G;
        }
        this.w0();
    ...
    public final void z0() {
        block19: {
            ...
            for (n4 = 0; n4 < n5; ++n4) {
                object2 = this.getChildAt(n4);
                object = (m)this.L.get(object2);
                if (object3.get(object2.getId()) || object == null) continue;
                this.B.t((m)object);
                ((m)object).I(n9, n10, this.N, this.getNanoTime());
            }
            float f3 = this.B.E();
                ...
                while (true) {
                    ...
                    if (!Float.isNaN(((m)object3).m)) {
                        ...
                        while (true) {
                            ...
                            f8 = f4;
                            if (!Float.isNaN(((m)object3).m)) {
                                f8 = Math.min(f4, ((m)object3).m);
                                f6 = Math.max(f3, ((m)object3).m);
                            }
                            ++n3;
                            f3 = f6;
                            f4 = f8;
                        }
                        for (n11 = n8; n11 < n5; ++n11) {
                            object3 = (m)this.L.get(this.getChildAt(n11));
                            if (Float.isNaN(((m)object3).m)) continue;
                            ((m)object3).o = 1.0f / (1.0f - f5);
                            ((m)object3).n = n4 != 0 ? f5 - (f3 - ((m)object3).m) / (f3 - f4) * f5 : f5 - (((m)object3).m - f4) * f5 / (f3 - f4);
                        }
                        break block19;
                    }
    ...
    public class d {
        ...
        public void a(Canvas canvas, HashMap object, int n3, int n4) {
            if (object != null && ((HashMap)object).size() != 0) {
                ...
                for (m m3 : ((HashMap)object).values()) {
                    int n5;
                    int n6 = n5 = m3.m();
                    if (n4 > 0) {
                        n6 = n5;
    ...
    public class e {
        ...
        public final void b(int n3, int n4) {
            ...
            if (((MotionLayout)object2).G == ((MotionLayout)object2).getStartState()) {
                ...
                if (object2 != null) {
                    ...
                    ((MotionLayout)object3).x((u.f)object4, n6, n7, n3);
                }
                return;
            }
            ...
            if (object5 != null) {
                ...
                n5 = n9 == 0 ? n3 : n4;
                n9 = n9 == 0 ? n4 : n3;
                ((MotionLayout)object).x((u.f)object2, n6, n5, n9);
            }
            object2 = this.g;
            object5 = this.b;
            object = this.d;
            ...
            ((MotionLayout)object2).x((u.f)object5, n6, n5, n3);
        }
        ...
        public u.e d(u.f e3, View view) {
            if (e3.u() == view) {
                return e3;
            }
            ArrayList arrayList = ((u.n)e3).w1();
            int n3 = arrayList.size();
            for (int i3 = 0; i3 < n3; ++i3) {
                e3 = (u.e)arrayList.get(i3);
            ...
            block10: {
                ...
                block9: {
                    ...
                    block8: {
                        ...
                        n6 = (int)((float)n5 + motionLayout.J0 * (float)(motionLayout.F0 - n5));
                    }
                    n8 = motionLayout.I0;
                ...
                n5 = (int)((float)n7 + motionLayout.J0 * (float)(motionLayout.G0 - n7));
            }
            bl = this.a.W1() || this.b.W1();
            boolean bl2 = this.a.U1() || this.b.U1();
            this.g.w(n3, n4, n6, n5, bl, bl2);
        }
