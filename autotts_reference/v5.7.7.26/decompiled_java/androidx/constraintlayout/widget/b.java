...
public class b {
    ...
    public static void G(Object object, String string, int n3) {
        ...
        if ((string = string.substring(n4 + 1)).length() <= 0) return;
        ...
        if (!"parent".equalsIgnoreCase(string2)) return;
        try {
    ...
    public void C(Context context, int n3) {
        ...
        block6: {
            ...
            block7: {
                ...
                Log.e((String)"ConstraintSet", (String)stringBuilder.toString(), (Throwable)iOException);
                return;
            }
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Error parsing resource: ");
