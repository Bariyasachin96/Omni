...
extends ViewGroup {
    ...
    public void f(boolean bl, View object, u.e e3, LayoutParams layoutParams, SparseArray sparseArray) {
        ...
        if (n11 != -1) {
            ...
            u.e e4;
            if (n5 != -1) {
                e4 = (u.e)sparseArray.get(n5);
                if (e4 != null) {
                    object = d.a.d;
                    e3.g0((d.a)((Object)object), e4, (d.a)((Object)object), layoutParams.leftMargin, n9);
                }
            ...
            } else if (n8 != -1 && (e4 = (u.e)sparseArray.get(n8)) != null) {
                object = d.a.f;
                e3.g0((d.a)((Object)object), e4, (d.a)((Object)object), layoutParams.rightMargin, n10);
            }
            if ((n9 = layoutParams.i) != -1) {
                e4 = (u.e)sparseArray.get(n9);
                if (e4 != null) {
                    object = d.a.e;
                    e3.g0((d.a)((Object)object), e4, (d.a)((Object)object), layoutParams.topMargin, layoutParams.x);
                }
            } else {
                n9 = layoutParams.j;
                if (n9 != -1 && (object = (u.e)sparseArray.get(n9)) != null) {
                    e3.g0(d.a.e, (u.e)object, d.a.g, layoutParams.topMargin, layoutParams.x);
                }
            }
            if ((n9 = layoutParams.k) != -1) {
                object = (u.e)sparseArray.get(n9);
                if (object != null) {
                    e3.g0(d.a.g, (u.e)object, d.a.e, layoutParams.bottomMargin, layoutParams.z);
                }
            } else {
                n9 = layoutParams.l;
                if (n9 != -1 && (e4 = (u.e)sparseArray.get(n9)) != null) {
                    object = d.a.g;
                    e3.g0((d.a)((Object)object), e4, (d.a)((Object)object), layoutParams.bottomMargin, layoutParams.z);
                }
            }
            if ((n9 = layoutParams.m) != -1) {
                this.A(e3, layoutParams, sparseArray, n9, d.a.h);
            } else {
                n9 = layoutParams.n;
                if (n9 != -1) {
                    this.A(e3, layoutParams, sparseArray, n9, d.a.e);
                } else {
                    n9 = layoutParams.o;
                    if (n9 != -1) {
                        this.A(e3, layoutParams, sparseArray, n9, d.a.g);
                    }
                }
            }
            if (f4 >= 0.0f) {
        ...
        if (bl && ((n9 = layoutParams.X) != -1 || layoutParams.Y != -1)) {
            e3.g1(n9, layoutParams.Y);
        }
        if (!layoutParams.e0) {
    ...
    public void onViewAdded(View view) {
        ...
        if (view instanceof Guideline && !(object instanceof h)) {
            ...
            h h3 = new h();
            ((LayoutParams)((Object)object)).v0 = h3;
            ((LayoutParams)((Object)object)).h0 = true;
            h3.F1(((LayoutParams)((Object)object)).Z);
        }
    ...
    public final void y() {
        ...
        int n5 = this.getChildCount();
        for (n4 = 0; n4 < n5; ++n4) {
            object = this.r(this.getChildAt(n4));
        ...
        if (bl) {
            for (n4 = 0; n4 < n5; ++n4) {
                ...
                try {
                    string = this.getResources().getResourceName(view.getId());
                    this.setDesignInformation(0, string, view.getId());
                    n3 = string.indexOf(47);
                    object = string;
                    if (n3 != -1) {
                        object = string.substring(n3 + 1);
                    }
                    this.p(view.getId()).H0((String)object);
                    continue;
                }
                catch (Resources.NotFoundException notFoundException) {}
            }
        ...
        if (this.n != -1) {
            for (n4 = 0; n4 < n5; ++n4) {
                ...
                if (object.getId() != this.n || !(object instanceof Constraints)) continue;
                this.l = ((Constraints)((Object)object)).getConstraintSet();
            }
        }
        if ((object = this.l) != null) {
            ((androidx.constraintlayout.widget.b)object).k(this, true);
        }
        this.e.z1();
        n3 = this.d.size();
        if (n3 > 0) {
        ...
        for (n4 = 0; n4 < n5; ++n4) {
            ...
            ((Placeholder)((Object)object)).c(this);
        }
        this.v.clear();
        this.v.put(0, (Object)this.e);
        this.v.put(this.getId(), (Object)this.e);
        for (n4 = 0; n4 < n5; ++n4) {
            string = this.getChildAt(n4);
            object = this.r((View)string);
            this.v.put(string.getId(), object);
        }
        n4 = 0;
        while (n4 < n5) {
            string = this.getChildAt(n4);
            object = this.r((View)string);
            if (object != null) {
                LayoutParams layoutParams = (LayoutParams)string.getLayoutParams();
                this.e.a((u.e)object);
                this.f(bl, (View)string, (u.e)object, layoutParams, this.v);
            }
            ++n4;
        }
        return;
