...
public abstract class l {
    ...
    public static int b(RecyclerView.z z3, i i3, View view, View view2, RecyclerView.p p3, boolean bl, boolean bl2) {
        if (p3.O() != 0 && z3.b() != 0 && view != null && view2 != null) {
            ...
            n3 = bl2 ? Math.max(0, z3.b() - n4 - 1) : Math.max(0, n3);
            if (!bl) {
                return n3;
            }
            int n5 = Math.abs(i3.d(view2) - i3.g(view));
            n4 = Math.abs(p3.l0(view) - p3.l0(view2));
            float f3 = (float)n5 / (float)(n4 + 1);
            return Math.round((float)n3 * f3 + (float)(i3.m() - i3.g(view)));
        }
        return 0;
    }
