...
implements o0.a0 {
    ...
    public final void B(Context object, String object2, AttributeSet attributeSet, int n3, int n4) {
        ...
        try {
            ...
            try {
                object2 = clazz.getConstructor(N0);
                Object[] objectArray = new Object[]{object, attributeSet, n3, n4};
                object = objectArray;
            }
            ...
            this.setLayoutManager((p)((Constructor)object2).newInstance((Object[])object));
            return;
        }
    ...
    public final boolean C0(View object, View view, int n3) {
        if (view != null && view != this && view != object) {
            ...
            n6 = (n6 < n9 || view.right <= n9) && view.right < ((Rect)object).right ? 1 : (((n5 = view.right) > (n4 = ((Rect)object).right) || n6 >= n4) && n6 > n9 ? -1 : 0);
            n5 = view.top;
            int n10 = ((Rect)object).top;
            if ((n5 < n10 || view.bottom <= n10) && view.bottom < ((Rect)object).bottom) {
                n7 = 1;
            } else {
                n9 = view.bottom;
                n4 = ((Rect)object).bottom;
                if (n9 <= n4 && n5 < n4 || n5 <= n10) {
                    n7 = 0;
                }
            }
            if (n3 != 1) {
    ...
    public final void G0(int n3, int n4, MotionEvent object, int n5) {
        ...
        this.p1(n10, n9, (MotionEvent)object, n5);
        object = this.i0;
        ...
        if (h3 != null) {
            if (!h3.j()) {
                ...
                while (true) {
                    d04 = d03;
                    if (n4 >= n3) break;
                    d02 = RecyclerView.m0(this.h.i(n4));
                    d04 = d03;
                    if (d02 != null) {
                        d04 = d03;
                        if (!d02.v()) {
...
lbl13:
                    ...
                    block22: {
                        block23: {
                            ...
                            if (this.Q == 1) {
                                ...
                                var15_7[0] = 0;
                                var15_7[1] = 0;
                                var6_12 = var9_11 - this.c1(var9_11, var1_1.getY());
                                var7_10 = var5_5 - this.d1(var5_5, var1_1.getX());
                                var8_13 = var10_3 != 0 ? var6_12 : 0;
                                var9_11 = var13_4 != false ? var7_10 : 0;
                                var5_5 = var6_12;
                                var4_6 = var7_10;
                                if (this.L(var8_13, var9_11, this.w0, this.u0, 0)) {
                                    var15_7 = this.w0;
                                    var5_5 = var6_12 - var15_7[0];
                                    var4_6 = var7_10 - var15_7[1];
                                    var15_7 = this.v0;
                                    var6_12 = var15_7[0];
                                    var16_14 = this.u0;
    ...
    public boolean p1(int n3, int n4, MotionEvent motionEvent, int n5) {
        ...
        nArray[0] = 0;
        nArray[1] = 0;
        this.M(n9, n8, n7, n6, this.u0, n5, nArray);
        nArray = this.w0;
        int n10 = nArray[0];
        int n11 = nArray[1];
        n5 = n10 == 0 && n11 == 0 ? 0 : 1;
        ...
        if (this.getOverScrollMode() != 2) {
            if (motionEvent != null && !o0.z.a(motionEvent, 8194)) {
                this.Y0(motionEvent.getX(), n7 - n10, motionEvent.getY(), n6 - n11);
            }
            this.w(n3, n4);
        }
        if (n9 != 0 || n8 != 0) {
    ...
    implements Runnable {
        ...
        public final int a(int n3, int n4) {
            int n5;
            int n6 = Math.abs(n3);
            n3 = n6 > (n5 = Math.abs(n4)) ? 1 : 0;
            RecyclerView recyclerView = this.i;
            n4 = n3 != 0 ? recyclerView.getWidth() : recyclerView.getHeight();
            n3 = n3 != 0 ? n6 : n5;
            return Math.min((int)(((float)n3 / (float)n4 + 1.0f) * 300.0f), 2000);
        }
        ...
        public void run() {
            ...
            if (object.computeScrollOffset()) {
                ...
                if (object3.o != null) {
                    ...
                    n5 = n8 - n4;
                    n7 = n6 - n3;
                    object2 = ((RecyclerView)object2).p.g;
                    if (object2 != null && !((y)object2).g() && ((y)object2).h()) {
                        n6 = this.i.k0.b();
                        if (n6 == 0) {
                            ((y)object2).r();
                        } else if (((y)object2).f() >= n6) {
                            ((y)object2).p(n6 - 1);
                            ((y)object2).j(n4, n3);
                        } else {
                            ((y)object2).j(n4, n3);
                ...
                object2[0] = false;
                object2[1] = false;
                object3.M(n6, n8, n5, n7, null, 1, (int[])object2);
                object2 = this.i;
                object3 = ((RecyclerView)object2).w0;
                n3 = n5 - object3[0];
                n4 = n7 - object3[1];
                if (n6 != 0 || n8 != 0) {
                    ((RecyclerView)object2).O(n6, n8);
                }
                ...
                object2 = this.i.p.g;
                if (!(object2 != null && ((y)object2).g() || n7 == 0)) {
                    if (this.i.getOverScrollMode() != 2) {
                    ...
                    this.d();
                    object = this.i;
                    object2 = ((RecyclerView)object).i0;
                    if (object2 != null) {
                        ((e)object2).f((RecyclerView)object, n6, n8);
                    }
                }
            }
        ...
        public d0 N(int var1_1, boolean var2_2, long var3_3) {
            block28: {
                block32: {
                    block31: {
                        block30: {
                            block29: {
                                ...
                                var16_8 = var15_6 = this.h(var1_1);
                                if (var15_6 == null) break block30;
                                var6_9 = 1;
                                var16_8 = var15_6;
                                break block31;
                            }
                    ...
                    var5_10 = var6_9;
                    if (var16_8 == null) {
                        var15_6 = var16_8 = this.m(var1_1, var2_2);
                        var5_10 = var6_9;
                        if (var16_8 != null) {
                            if (!this.Q((d0)var16_8)) {
                                if (!var2_2) {
                                    var16_8.b(4);
                                    if (var16_8.w()) {
                                        this.h.removeDetachedView(var16_8.a, false);
                                        var16_8.K();
                                    } else if (var16_8.L()) {
                                        var16_8.e();
                                    }
                    ...
                    if (var15_6 == null) {
                        ...
                        if (var7_11 >= 0 && var7_11 < this.h.o.f()) {
                            ...
                            var6_9 = var5_10;
                            if (this.h.o.j()) {
                                var16_8 = var15_6 = this.l(this.h.o.g(var7_11), var8_12, var2_2);
                                var6_9 = var5_10;
                                if (var15_6 != null) {
                                    var15_6.c = var7_11;
                                    var6_9 = 1;
                            ...
                            var7_11 = var6_9;
                            if (var15_6 == null) {
                                var11_13 = this.h.getNanoTime();
                                if (var3_3 != 0x7FFFFFFFFFFFFFFFL && !this.g.n(var8_12, var11_13, var3_3)) {
                                    return null;
                                }
                                var15_6 = this.h;
                                var16_8 = var15_6.o.e((ViewGroup)var15_6, var8_12);
                                if (RecyclerView.K0 && (var15_6 = RecyclerView.b0(var16_8.a)) != null) {
                                    var16_8.b = new WeakReference<Object>(var15_6);
                                }
                                var9_14 = this.h.getNanoTime();
                                this.g.g(var8_12, var9_14 - var11_13);
                                var2_2 = RecyclerView.D0;
                                var7_11 = var6_9;
                            }
                        } else {
                            ...
                            var15_6.append(this.h.k0.b());
                            var15_6.append(this.h.V());
                            throw new IndexOutOfBoundsException(var15_6.toString());
                        }
                    }
                    if (var7_11 != 0 && !this.h.k0.e() && var16_8.p(8192)) {
                        var16_8.F(0, 8192);
                        if (this.h.k0.k) {
                            var5_10 = androidx.recyclerview.widget.RecyclerView$m.e((d0)var16_8);
                            var15_6 = this.h;
                            var15_6 = var15_6.P.t(var15_6.k0, (d0)var16_8, var5_10 | 4096, var16_8.o());
                            this.h.Z0((d0)var16_8, (m.b)var15_6);
                        }
                    }
                    if (!this.h.k0.e() || !var16_8.s()) break block32;
                    var16_8.g = var1_1;
                    ** GOTO lbl-1000
                }
                if (var16_8.s() && !var16_8.z() && !var16_8.t()) lbl-1000:
                // 2 sources

                {
                    var2_2 = false;
                } else {
                    if (RecyclerView.D0 && var16_8.v()) {
                        var15_6 = new StringBuilder();
                        var15_6.append("Removed holder should be bound and it should come here only in pre-layout. Holder: ");
                        var15_6.append(var16_8);
                        var15_6.append(this.h.V());
                        throw new IllegalStateException(var15_6.toString());
                    }
                    var2_2 = this.M((d0)var16_8, this.h.g.m(var1_1), var1_1, var3_3);
                }
                var15_6 = var16_8.a.getLayoutParams();
                if (var15_6 == null) {
                    var15_6 = (LayoutParams)this.h.generateDefaultLayoutParams();
                    var16_8.a.setLayoutParams((ViewGroup.LayoutParams)var15_6);
                } else if (!this.h.checkLayoutParams((ViewGroup.LayoutParams)var15_6)) {
                    var15_6 = (LayoutParams)this.h.generateLayoutParams((ViewGroup.LayoutParams)var15_6);
                    var16_8.a.setLayoutParams((ViewGroup.LayoutParams)var15_6);
                } else {
                    var15_6 = (LayoutParams)var15_6;
                }
                var15_6.a = var16_8;
