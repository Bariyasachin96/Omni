...
implements Cloneable {
    ...
    public void l(ViewGroup object, boolean bl) {
        ...
        if (!bl && (object = this.J) != null) {
            ...
            while (true) {
                if (n3 >= n5) break;
                object2 = (String)this.J.f(n3);
                ((ArrayList)object).add((View)this.r.d.remove(object2));
                ++n3;
            }
            for (int i3 = n4; i3 < n5; ++i3) {
                y3 = (View)((ArrayList)object).get(i3);
                if (y3 == null) continue;
                object2 = (String)this.J.j(i3);
            ...
            block17: {
                ...
                block11: {
                    ...
                    block18: {
                                ...
                                block15: {
                                    block16: {
                                        block13: {
                                            ...
                                            object3 = new y(view);
                                            y y7 = (y)var3_5.a.get(view);
                                            if (y7 == null) break block16;
                                            for (n6 = 0; n6 < stringArray.length; ++n6) {
                                                Map map = ((y)object3).a;
                                                String string = stringArray[n6];
                                                map.put(string, y7.a.get(string));
                                            }
                                            break block16;
                                        }
                                        l4 = l3;
                        ...
                        if (sparseIntArray.size() != 0) {
                            for (n3 = 0; n3 < sparseIntArray.size(); ++n3) {
                                ...
                                d d3 = (d)a4.get((Animator)this.G.get(n4));
                                l4 = sparseIntArray.valueAt(n3);
                    ...
                    for (n6 = 0; n6 < n5; ++n6) {
                        ...
                        if (d4.c == null || d4.a != view || !d4.b.equals(this.A()) || !d4.c.equals(object3)) continue;
                        y5 = null;
                ...
                if (y5 != null) {
                    ...
                    a4.put(y5, new d(view, this.A(), this, object.getWindowId(), (y)var16_26, (Animator)y5));
                    this.G.add(y5);
                }
            }
            ++n4;
