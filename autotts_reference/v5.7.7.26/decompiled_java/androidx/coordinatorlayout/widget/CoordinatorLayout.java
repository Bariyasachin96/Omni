...
d0 {
    ...
    public final void J(View object, Rect rect, int n3) {
        if (x0.O((View)object) && object.getWidth() > 0 && object.getHeight() > 0) {
            ...
            if ((n5 & 5) == 5 && (n5 = this.getWidth() - rect2.right - e3.rightMargin + e3.i) < (n4 = rect.right)) {
                this.Y((View)object, n5 - n4);
                n3 = n6;
            }
            if (n3 == 0) {
    ...
    public final void L(int n3) {
        ...
        for (int i3 = 0; i3 < n5; ++i3) {
            ...
            for (n6 = 0; n6 < i3; ++n6) {
                ...
                if (((e)((Object)object)).l != view) continue;
                this.K(view2, n4);
            }
            this.u(view2, true, rect2);
            if (((e)((Object)object)).g != 0 && !rect2.isEmpty()) {
                n6 = o0.s.b(((e)((Object)object)).g, n4);
                int n7 = n6 & 0x70;
                if (n7 != 48) {
                    if (n7 == 80) {
            ...
            if (((e)((Object)object)).h != 0 && view2.getVisibility() == 0) {
            ...
            for (n6 = i3 + 1; n6 < n5; ++n6) {
                ...
                e e3 = (e)view.getLayoutParams();
                object = e3.f();
                if (object == null || !((Behavior)object).i(this, view, view2)) continue;
                if (n3 == 0 && e3.g()) {
                    e3.k();
                    continue;
                }
                if (n3 != 2) {
                    bl = ((Behavior)object).l(this, view, view2);
                } else {
                    ((Behavior)object).m(this, view, view2);
                    bl = true;
                }
                if (n3 != 1) continue;
                e3.p(bl);
        ...
        while (true) {
            block9: {
                ...
                if (var8_16 && !x0.v(var26_27 /* !! */ )) {
                    var15_24 = var27_3.q.j();
                    var25_26 = var27_3.q.k();
                    var18_25 = var27_3.q.l();
                    var14_23 = var27_3.q.i();
                    var15_24 = View.MeasureSpec.makeMeasureSpec((int)(var22_11 - (var15_24 + var25_26)), (int)var21_10);
    ...
    public void onRestoreInstanceState(Parcelable object) {
        ...
        super.onRestoreInstanceState(((AbsSavedState)object).o());
        SparseArray sparseArray = ((SavedState)object).e;
        int n3 = this.getChildCount();
        for (int i3 = 0; i3 < n3; ++i3) {
            Parcelable parcelable;
            View view = this.getChildAt(i3);
            int n4 = view.getId();
            object = this.C(view).f();
            if (n4 == -1 || object == null || (parcelable = (Parcelable)sparseArray.get(n4)) == null) continue;
            ((Behavior)object).B(this, view, parcelable);
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        for (int i3 = 0; i3 < n3; ++i3) {
            ...
            int n4 = view.getId();
            Behavior behavior = ((e)view.getLayoutParams()).f();
            if (n4 == -1 || behavior == null || (behavior = behavior.C(this, view)) == null) continue;
            sparseArray.append(n4, (Object)behavior);
        }
...
lbl15:
    ...
    extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int n3) {
            ...
            Parcelable[] parcelableArray = this.e;
            int n4 = parcelableArray != null ? parcelableArray.size() : 0;
            parcel.writeInt(n4);
            int[] nArray = new int[n4];
            parcelableArray = new Parcelable[n4];
            for (int i3 = 0; i3 < n4; ++i3) {
                nArray[i3] = this.e.keyAt(i3);
