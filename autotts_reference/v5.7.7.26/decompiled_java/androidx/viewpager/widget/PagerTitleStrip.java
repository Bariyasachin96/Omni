...
extends ViewGroup {
    ...
    public void c(int n3, float f3, boolean bl) {
            ...
            block7: {
                ...
                block4: {
                    block5: {
                        ...
                        n15 = this.e.getMeasuredWidth();
                        n11 = this.f.getMeasuredWidth();
                        n10 = n15 / 2;
                        n9 = this.getWidth();
                        n3 = this.getHeight();
                        ...
                        n4 = n9 - n4 - (int)((float)(n9 - (n8 + n10) - n4) * f5) - n10;
                        n10 = n15 + n4;
                        n14 = this.d.getBaseline();
                        n13 = this.e.getBaseline();
                        int n17 = this.f.getBaseline();
                        n15 = Math.max(Math.max(n14, n13), n17);
                        n14 = n15 - n14;
                        n13 = n15 - n13;
                        n15 -= n17;
                        int n18 = this.d.getMeasuredHeight();
                        n17 = this.e.getMeasuredHeight();
                        n16 = this.f.getMeasuredHeight();
                        n16 = Math.max(Math.max(n18 + n14, n17 + n13), n16 + n15);
                        n17 = this.j & 0x70;
        ...
        textView.layout(n4, n5, n10, textView.getMeasuredHeight() + n5);
        n5 = Math.min(n8, n4 - this.i - n12);
        textView = this.d;
        textView.layout(n5, n3, n5 + n12, textView.getMeasuredHeight() + n3);
        n3 = Math.max(n9 - n7 - n11, n10 + this.i);
        textView = this.f;
        textView.layout(n3, n6, n3 + n11, textView.getMeasuredHeight() + n6);
        this.h = f3;
        this.l = false;
    }
