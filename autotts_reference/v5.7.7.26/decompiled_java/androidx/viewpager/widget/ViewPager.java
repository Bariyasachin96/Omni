    ...
    public void p() {
        ...
        x0.r0((View)this, new f0(this){
            ...
            public z1 a(View view, z1 z12) {
                ...
                for (int i3 = 0; i3 < n3; ++i3) {
                    z1 z13 = x0.g(this.b.getChildAt(i3), z12);
                    view.left = Math.min(z13.j(), view.left);
                    view.top = Math.min(z13.l(), view.top);
                    view.right = Math.min(z13.k(), view.right);
                    view.bottom = Math.min(z13.i(), view.bottom);
                }
                return z12.q(view.left, view.top, view.right, view.bottom);
            }
        });
    }
