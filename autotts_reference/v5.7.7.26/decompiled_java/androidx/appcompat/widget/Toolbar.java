...
implements v {
    ...
    public Toolbar(Context object, AttributeSet attributeSet, int n3) {
        ...
        n5 = ((m0)object2).e(c.j.Toolbar_contentInsetEnd, Integer.MIN_VALUE);
        n3 = ((m0)object2).f(c.j.Toolbar_contentInsetLeft, 0);
        n4 = ((m0)object2).f(c.j.Toolbar_contentInsetRight, 0);
        this.i();
        this.v.e(n3, n4);
        if (n6 != Integer.MIN_VALUE || n5 != Integer.MIN_VALUE) {
            this.v.g(n6, n5);
        }
...
lbl23:
...

        {
            ...
            if (var2_2 != 48) {
                if (var2_2 != 80) {
                    ...
                    if (var10_18 < var16_19 + var2_2) {
                        ...
                        var14_12 = var18_17.bottomMargin;
                        var9_13 = this.u;
                        var2_2 = var10_18;
                        if (var15_8 < var14_12 + var9_13) {
                            var2_2 = Math.max(0, var10_18 - (var19_20 /* !! */ .bottomMargin + var9_13 - var15_8));
                        }
                    }
            ...
            if (var8_6 != 0) {
                ...
                if (var17_16) {
                    ...
                    var9_13 = var8_6 + var18_17.bottomMargin;
                } else {
                    var8_6 = var3_3;
                    var9_13 = var2_2;
                    var2_2 = var8_6;
                ...
                if (var1_1) {
                    var10_18 = var9_13 + ((LayoutParams)this.e.getLayoutParams()).topMargin;
    ...
    public void onMeasure(int n3, int n4) {
        ...
        n3 = View.resolveSizeAndState((int)Math.max(n11 + (n6 + n7), this.getSuggestedMinimumHeight()), (int)n4, (int)(n12 << 16));
        if (this.L()) {
            n3 = n9;
        }
        ...
        public boolean l(androidx.appcompat.view.menu.e object, androidx.appcompat.view.menu.g g3) {
            ...
            if (object != toolbar) {
                if (object instanceof ViewGroup) {
                    ((ViewGroup)object).removeView((View)toolbar.j);
                }
                object = this.e;
            ...
            this.d = g3;
            toolbar = this.e.k.getParent();
            if (toolbar != (object = this.e)) {
                if (toolbar instanceof ViewGroup) {
                    ((ViewGroup)toolbar).removeView(((Toolbar)object).k);
                }
                object = this.e.o();
                toolbar = this.e;
                ((ActionBar.LayoutParams)((Object)object)).a = toolbar.p & 0x70 | 0x800003;
                ((LayoutParams)((Object)object)).b = 2;
                toolbar.k.setLayoutParams((ViewGroup.LayoutParams)object);
                object = this.e;
