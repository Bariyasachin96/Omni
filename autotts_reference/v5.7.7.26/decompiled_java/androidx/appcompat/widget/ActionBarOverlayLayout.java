...
d0 {
    ...
    public void onLayout(boolean bl, int n3, int n4, int n5, int n6) {
        ...
        for (n3 = 0; n3 < n5; ++n3) {
            ...
            int n10 = layoutParams.topMargin + n6;
    ...
    public void onMeasure(int n3, int n4) {
        ...
        n8 = View.combineMeasuredStates((int)n9, (int)this.e.getMeasuredState());
        ...
        this.setMeasuredDimension(View.resolveSizeAndState((int)Math.max(n5 + (n10 + n9), this.getSuggestedMinimumWidth()), (int)n3, (int)n8), View.resolveSizeAndState((int)n6, (int)n4, (int)(n8 << 16)));
    }
