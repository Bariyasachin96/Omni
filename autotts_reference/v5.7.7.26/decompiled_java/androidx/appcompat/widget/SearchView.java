...
implements c {
    ...
    public SearchView(Context object, AttributeSet attributeSet, int n3) {
        ...
        this.t = view2 = this.findViewById(c.f.search_plate);
        this.u = view = this.findViewById(c.f.submit_area);
        this.v = imageView3 = (ImageView)this.findViewById(c.f.search_button);
        attributeSet = (ImageView)this.findViewById(c.f.search_go_btn);
        this.w = attributeSet;
        this.x = imageView2 = (ImageView)this.findViewById(c.f.search_close_btn);
        object2 = (ImageView)this.findViewById(c.f.search_voice_btn);
        this.y = (ImageView)object2;
        this.F = imageView = (ImageView)this.findViewById(c.f.search_mag_icon);
        x0.k0(view2, m02.g(c.j.SearchView_queryBackground));
        x0.k0(view, m02.g(c.j.SearchView_submitBackground));
        n3 = c.j.SearchView_searchIcon;
        imageView3.setImageDrawable(m02.g(n3));
        attributeSet.setImageDrawable(m02.g(c.j.SearchView_goIcon));
        imageView2.setImageDrawable(m02.g(c.j.SearchView_closeIcon));
        object2.setImageDrawable(m02.g(c.j.SearchView_voiceIcon));
        imageView.setImageDrawable(m02.g(n3));
        this.G = m02.g(c.j.SearchView_searchHintIcon);
        r0.a((View)imageView3, this.getResources().getString(c.h.abc_searchview_description_search));
        ...
        attributeSet.setOnClickListener(onClickListener);
