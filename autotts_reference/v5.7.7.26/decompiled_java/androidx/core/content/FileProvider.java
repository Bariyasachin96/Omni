...
extends ContentProvider {
    ...
    public void attachInfo(Context object, ProviderInfo object2) {
        ...
        if (((ProviderInfo)object2).exported) {
            throw new SecurityException("Provider must not be exported");
        }
        if (((ProviderInfo)object2).grantUriPermissions) {
            object = ((ProviderInfo)object2).authority.split(";")[0];
            object2 = this.c;
     ...
     * Enabled aggressive block sorting
     */
    public Cursor query(Uri objectArray, String[] object, String string, String[] object2, String objectArray2) {
        File file = this.f().a((Uri)objectArray);
        String string2 = objectArray.getQueryParameter("displayName");
        objectArray = object;
        if (object == null) {
            objectArray = g;
        }
            ...
            block10: {
                block9: {
                    ...
                    block8: {
                        void var2_7;
                        if (n4 >= n3) {
                            String[] stringArray2 = FileProvider.d(stringArray, n5);
                            objectArray = FileProvider.c(objectArray3, n5);
                            MatrixCursor matrixCursor = new MatrixCursor(stringArray2, 1);
                            matrixCursor.addRow(objectArray);
                            return matrixCursor;
                        }
                        object3 = objectArray[n4];
                        if (!"_display_name".equals(object3)) break block8;
                        stringArray[n5] = "_display_name";
                        n6 = n5 + 1;
                        if (string2 == null) {
                        ...
                        objectArray3[n5] = var2_7;
                        n5 = n6;
                        break block9;
                    }
                    n6 = n5;
                    if (!"_size".equals(object3)) break block10;
                    stringArray[n5] = "_size";
                    n6 = n5 + 1;
                    objectArray3[n5] = file.length();
                    n5 = n6;
                }
                n6 = n5;
            }
