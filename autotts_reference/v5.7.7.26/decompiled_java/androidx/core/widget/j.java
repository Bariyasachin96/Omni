        ...
        public final void g(Menu menu) {
            ...
            if (!bl) {
                ...
                try {
                    ...
                    this.d = menuItem.getDeclaredMethod("removeItemAt", new Class[]{object});
                    this.e = true;
                }
            ...
            try {
                object = this.e && this.c.isInstance(menu) ? this.d : menu.getClass().getDeclaredMethod("removeItemAt", new Class[]{object});
            }
            ...
            for (n3 = menu.size() - 1; n3 >= 0; --n3) {
                ...
                ((Method)object).invoke((Object)menu, n3);
                continue;
            }
            object = this.c(context, packageManager);
            for (n3 = 0; n3 < object.size(); ++n3) {
                context = (ResolveInfo)object.get(n3);
                menu.add(0, 0, n3 + 100, context.loadLabel(packageManager)).setIntent(this.b((ResolveInfo)context, this.b)).setShowAsAction(1);
            }
            return;
        }
