...
implements i {
    ...
    public final void h(String string) {
        ...
        Object object2;
        try {
            object2 = Class.forName(string, false, Recreator.class.getClassLoader()).asSubclass(a.a.class);
            k.d(object2, "{\n                Class.…class.java)\n            }");
        }
        ...
        try {
            object = ((Class)object2).getDeclaredConstructor(null);
            ((AccessibleObject)object).setAccessible(true);
        }
        catch (NoSuchMethodException noSuchMethodException) {
            StringBuilder stringBuilder = new StringBuilder();
            stringBuilder.append("Class ");
            stringBuilder.append(((Class)object2).getSimpleName());
        ...
        try {
            object2 = ((Constructor)object).newInstance(null);
            k.d(object2, "{\n                constr…wInstance()\n            }");
            object2 = (a.a)object2;
            object2.a(this.a);
            return;
