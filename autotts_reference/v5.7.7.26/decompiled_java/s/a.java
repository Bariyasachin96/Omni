...
lbl28:
            ...
            var18_14[var14_6] = new a(var12_11, var10_10, var8_9, var6_8, var4_7, var19_15[0], var19_15[1]);
            var14_6 = var13_5;
            var16_4 = var15_12;
            var13_5 = var12_11;
        }
    ...
    public double c(double d3, int n3) {
        ...
        if (bl) {
            ...
            if (d3 > object[((a[])object).length - 1].d) {
                double d6;
                double d7 = object[((a[])object).length - 1].d;
    ...
    public static class a {
        ...
        public final void a(double d3, double d4, double d5, double d6) {
            ...
            for (n3 = 0; n3 < (dArray = this.a).length; ++n3) {
                d3 = (double)n3 / (double)(dArray.length - 1);
                int n4 = Arrays.binarySearch(s, d3);
                if (n4 >= 0) {
                ...
                dArray = s;
                d5 = dArray[n5];
                this.a[n3] = d3 = (d4 + (d3 - d5) / (dArray[n4 - 1] - d5)) / (double)(dArray.length - 1);
            }
        }
