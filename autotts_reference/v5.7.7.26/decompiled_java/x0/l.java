...
public final class l {
    ...
    public final void d() {
        ...
        if (this.i != Double.MAX_VALUE) {
            ...
            if (d3 > 1.0) {
                ...
                d4 = -d3;
                d5 = this.a;
                this.g = d4 * d5 - d5 * Math.sqrt(d3 * d3 - 1.0);
    ...
    public h.o j(double d3, double d4, long l3) {
        ...
        if (d7 > 1.0) {
            ...
            d8 = this.g;
            d6 = Math.pow(Math.E, d8 * d5);
            double d9 = this.f;
            d4 = d7 * d8 * d6 + d4 * d9 * Math.pow(Math.E, d9 * d5);
        } else if (d7 == 1.0) {
            d3 = this.a;
            d4 += d3 * d6;
            ...
            d7 = -d13;
            d12 = this.b;
            double d14 = Math.pow(Math.E, -d12 * d13 * d5);
            double d15 = this.h;
            d13 = -d15;
            d15 = Math.sin(d15 * d5);
            double d16 = this.h;
            d4 = d7 * d3 * d12 + d14 * (d13 * d6 * d15 + d4 * d16 * Math.cos(d16 * d5));
        }
        h.o o3 = this.j;
