...
public class z1 {
        ...
        public static z1 a(View object) {
            block5: {
                if (d && object.isAttachedToWindow()) {
                    ...
                    object3 = (Rect)c.get(object3);
                    if (object2 == null || object3 == null) break block5;
                    try {
                        b b3 = new b();
                        object2 = b3.c(g0.b.c((Rect)object2)).d(g0.b.c((Rect)object3)).a();
    ...
    extends f {
        ...
        private static WindowInsets i() {
            ...
            if ((constructor = g) == null) return null;
            try {
                field = new Rect();
                return (WindowInsets)constructor.newInstance(field);
            }
            catch (ReflectiveOperationException reflectiveOperationException) {
                return null;
            }
        ...
        public g0.b u(int n3, boolean bl) {
            if (n3 != 1) {
                ...
                if (bl) {
                    object = this.v();
                    b3 = this.i();
                    return g0.b.b(Math.max(((g0.b)object).a, b3.a), 0, Math.max(((g0.b)object).c, b3.c), Math.max(((g0.b)object).d, b3.d));
                }
                b3 = this.k();
                z1 z12 = this.f;
                if (z12 != null) {
