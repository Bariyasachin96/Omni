...
public abstract class x0 {
    ...
    public static void Q(View view, int n3) {
        ...
        block10: {
            block9: {
                object = (AccessibilityManager)view.getContext().getSystemService("accessibility");
        ...
        object.setEventType(n4);
        object.setContentChangeTypes(n3);
        if (bl) {
            object.getText().add(x0.n(view));
            x0.p0(view);
        }
