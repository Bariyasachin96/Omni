...
extends o0 {
    ...
    public long c(ViewGroup viewGroup, Transition transition, y object, y y3) {
        ...
        reference var10_9 = object[0] + Math.round(viewGroup.getTranslationX());
        reference var12_10 = object[1] + Math.round(viewGroup.getTranslationY());
        int n6 = viewGroup.getWidth() + var10_9;
        int n7 = viewGroup.getHeight() + var12_10;
        if (rect != null) {
            object3 = rect.centerX();
            object2 = rect.centerY();
        } else {
            object3 = (var10_9 + n6) / 2;
            object2 = (var12_10 + n7) / 2;
        }
        float f3 = (float)this.h((View)viewGroup, n4, n5, (int)object3, (int)object2, (int)var10_9, (int)var12_10, n6, n7) / (float)this.i(viewGroup);
